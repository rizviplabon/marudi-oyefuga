...
class Ion_auth_model extends CI_Model {
    ...
    public string $store_salt;
    public string $salt_length;
    public array $join = [];
    public string $hash_method;
    public string $default_rounds;
    public string $random_rounds;
    public string $min_rounds;
    public string $max_rounds;
    public string $message_start_delimiter;
    public string $message_end_delimiter;
    /**
