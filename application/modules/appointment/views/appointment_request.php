    ...
    <div class="container-fluid">
                <div class="row">
                            <div class="col-12 content-header">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0"><?php echo lang('appointment'); ?> <?php echo lang('requests'); ?></h4>
                                    &nbsp;&nbsp; &nbsp;&nbsp;
                        &nbsp;&nbsp;
                        ...
                        <?php }} ?>
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active"><?php echo lang('requests'); ?></li>
        ...
        <div class="card">
                                <div class="card-header table_header">
                                        <h4 class="card-title mb-0 col-lg-8"><?php echo lang('appointment'); ?> <?php echo lang('requests'); ?></h4> 
