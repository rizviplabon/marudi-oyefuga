        ...
        <div class="st-top-header">
            <div class="container">
                <div class="st-top-header-in">
                    ...
                    <a href="#appointment" class="st-top-header-btn st-smooth-move">Register Hospital</a>
                </div>
            </div>
        </div>
    ...
    foreach ($slides as $slide) { 
      ...
      ?>
        <div class="st-hero-wrap st-gray-bg st-dynamic-bg overflow-hidden st-fixed-bg"
            data-src="themes/assets/img/hero-bg.jpg">
        ...
        $styled_text = implode(' ', $words);
          ...
          ?>
                        ...
                        <div class="st-hero-subtitle"><?php echo $first_section1; ?> <br>
                            <?php echo $second_section1; ?></div>
                        <div class="st-hero-btn">
                            <a href="#appointment" class="st-btn st-style1 st-color1 st-smooth-move">Register
                                Hospital</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="slick-wrapper">
                        <div class="slick-slide-in">
                            <div class="st-hero-img" >
                                <img style="width: 580px; height:780px;" src="<?php echo $slide->img_url; ?>" alt="Hero img">
                            </div>
                        </div>
                    ...
                    <div class="st-isotop st-style1 st-port-col-3 st-has-gutter st-lightgallery">
                        ...
                        <div class="st-isotop-item <?php echo $image->position; ?>">
                            <a href="<?php echo $image->img; ?>" class="st-project st-zoom st-lightbox-item st-link-hover-wrap">
                                <div class="st-project-img st-zoom-in"><img style="height:286px; width:553px;" src="<?php echo $image->img; ?>"
                                        alt="project1"></div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xl-6 wow fadeInRight" data-wow-duration="0.8s" data-wow-delay="0.2s">
                      ...
                      L184,203.6l-0.4,0.4-58.8,34c-0.4,0-0.4,0.4-0.8,0.4c0,0-0.4,0-0.4,0.4h-0.4c-0.4,0-0.8-0.4-1.2-0.4c-0.4-0.4-0.4-0.8-0.4-1.2
