...
<body>
                ...
                <div class="st-top-header-in">
                    <ul class="st-top-header-list">
                        ...
                        <li>
                            ...
                            <a href="#"><?php echo $settings->phone; ?></a>
                        </li>
                    </ul>
                    <a href="#appointment" class="st-top-header-btn st-smooth-move">Hospital Register</a>
                </div>
            </div>
        </div>
                    ...
                    <div class="st-main-header-right">
                        <div class="st-nav">
                            ...
                            <ul class="st-nav-list st-onepage-nav">
                                ...
                                <li><a href="#review" class="st-smooth-move">Review</a></li>
                                ...
                                <li><a href="<?php echo $link; ?>" target="_blank"
                                        class="" style='font-weight:bold;'><?php echo $link_lang; ?></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    foreach ($slides as $slide) { 
      ...
      ?>
        <!-- Start Hero Seciton -->
        <div class="st-hero-wrap st-gray-bg st-dynamic-bg overflow-hidden youtube-bg st-white-overlay"
            data-src="themes/assets/img/youtube-video-bg.jpg">
            <div id="bgndVideo" class="player"
                data-property="{videoURL:'<?php echo $settings->video_link; ?>', containment:'.youtube-bg',autoPlay:true, mute:true, startAt:1, opacity:1, showControls:false, loop:true}">
            </div>
          ...
          $text = $slide->title;
          $words = explode(' ', $text);
          $first_six_words = array_slice($words, 0, 2);
        ...
        $styled_text = implode(' ', $words);
          ...
          ?>
                        ...
                        <div class="st-hero-subtitle st-primary-color"><?php echo $first_section1; ?> <br>
                            <?php echo $second_section1; ?></div>
                        <div class="st-hero-btn">
                            <a href="#appointment" class="st-btn st-style1 st-color1 st-smooth-move">Hospital
                                Register</a>
                        </div>
                    </div>
                </div>
                <div class="st-hero-social-group">
                    <div class="container">
                        <ul class="st-social-btn st-style1 st-mp0">
                            ...
                            <li><a href="<?php echo $settings->google_id; ?>"><i class="fab fa-linkedin"></i></a></li>
                            <li><a href="<?php echo $settings->youtube_id; ?>"><i
                                        class="fab fa-pinterest-square"></i></a></li>
                            <li><a href="<?php echo $settings->twitter_id; ?>"><i class="fab fa-twitter-square"></i></a>
                            </li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="st-hero-shape"><img src="themes/assets/img/shape/hero-shape.png" alt="hero shape"></div>
        </div>
        <!-- End Hero Seciton -->
        <?php } ?>
                ...
                <div class="row">
                    <div class="col-lg-4">
                      ...
                      s-23.8-10.676-23.8-23.8c0-13.124,10.677-23.8,23.8-23.8S389.001,385.251,389.001,398.375z" />
                            ...
                            <h2 class="st-iconbox-title">Qualified Employees</h2>
                    ...
                    <div class="col-lg-4">
                        <div class="st-iconbox st-style1">
                            ...
                            <div class="st-iconbox-text">We have a team of highly skilled emergency Developers, we
                                provide rapid of technical emergencies</div>
                        </div>
                        <div class="st-height-b0 st-height-lg-b30"></div>
                    </div><!-- .col -->
                </div>
          ...
          ?>
            ...
            <div class="container">
                <div class="row">
                        ...
                        <div class="st-vertical-middle">
                            <div class="st-vertical-middle-in">
                                <div class="st-text-block st-style1">
                                    <h2 class="st-text-block-title"><?php echo $settings->verified_1; ?></h2>
                    ...
                    <div class="st-avatar-img"><img src="<?php echo $settings->comment_logo_2; ?>" alt="avatar"></div>
                    <div class="st-avatar-info">
                      <h4 class="st-avatar-name"><?php echo $settings->verified_2; ?></h4>
...
<section id="department">
      ...
      <div class="container">
        <div class="st-tabs st-fade-tabs st-style1">
          <ul class="st-tab-links st-style1 st-mp0">
            ...
            <?php $crutches_details = $this->db->get_where('crutches', array('id' => 1))->row(); ?>
              <a href="#<?php echo $crutches_details->name; ?>" class="st-blue-box">
                ...
                <span><?php echo $crutches_details->name; ?></span>
              </a>
            </li>
            <li class="st-tab-title">
            <?php $xray_details = $this->db->get_where('crutches', array('id' => 2))->row(); ?>
              <a href="#<?php echo $xray_details->name; ?>" class="st-red-box">
                ...
                <span><?php echo $xray_details->name; ?></span>
              </a>
            </li>
            <li class="st-tab-title">
            <?php $pulmonary_details = $this->db->get_where('crutches', array('id' => 3))->row(); ?>
              <a href="#<?php echo $pulmonary_details->name; ?>" class="st-green-box">
                <svg enable-background="new 0 0 512 512" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                  <g>
                    <path
                ...
                <span><?php echo $pulmonary_details->name; ?></span>
                
              </a>
            </li>
            <li class="st-tab-title">
            <?php $cardiology_details = $this->db->get_where('crutches', array('id' => 4))->row(); ?>
              <a href="#<?php echo $cardiology_details->name; ?>" class="st-dip-blue-box">
                ...
                <span><?php echo $cardiology_details->name; ?></span>
                
              </a>
            </li>
            <li class="st-tab-title">
            <?php $dental_details = $this->db->get_where('crutches', array('id' => 5))->row(); ?>
              <a href="#<?php echo $dental_details->name; ?>" class="st-orange-box">
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
                ...
                <span><?php echo $dental_details->name; ?></span>
                
              </a>
            </li>
            <li class="st-tab-title">
            <?php $neurology_details = $this->db->get_where('crutches', array('id' => 6))->row(); ?>
           
              <a href="#<?php echo $neurology_details->name; ?>" class="st-gray-box">
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
                ...
                <span><?php echo $neurology_details->name; ?></span>
              </a>
            </li>
          </ul>
          <div class="st-height-b25 st-height-lg-b25"></div>
          <div class="tab-content">
            <div id="<?php echo $crutches_details->name; ?>" class="st-tab active">
              <div class="st-imagebox st-style2">
                <div class="row">
                  <div class="col-lg-6">
                    <div class="st-imagebox-img"><img style="height:400px; width:505px;" src="<?php echo $crutches_details->img; ?>" alt="cc"></div>
                    <div class="st-height-b0 st-height-lg-b30"></div>
                  </div>
                  <div class="col-lg-6">
                    <div class="st-vertical-middle">
                      <div class="st-vertical-middle-in">
                        <div class="st-imagebox-info">
                          <h2 class="st-imagebox-title"><?php echo $crutches_details->designation; ?></span></h2>
                          <h4 class="st-imagebox-subtitle"><?php echo $crutches_details->crutches; ?> </h4>
                          <div class="st-imagebox-text"><?php echo $crutches_details->status; ?></div>
                        </div>
            ...
            <div id="<?php echo $xray_details->name; ?>" class="st-tab">
              <div class="st-imagebox st-style2">
                <div class="row">
                  <div class="col-lg-6">
                    <div class="st-imagebox-img"><img style="height:400px; width:505px;" src="<?php echo $xray_details->img; ?>" alt="service"></div>
                    <div class="st-height-b0 st-height-lg-b30"></div>
                  </div>
                  <div class="col-lg-6">
                    <div class="st-vertical-middle">
                      <div class="st-vertical-middle-in">
                        <div class="st-imagebox-info">
                        <h2 class="st-imagebox-title"><?php echo $xray_details->designation; ?></span></h2>
                          <h4 class="st-imagebox-subtitle"><?php echo $xray_details->crutches; ?> </h4>
                          <div class="st-imagebox-text"><?php echo $xray_details->status; ?></div>
                        </div>
            ...
            <div id="<?php echo $pulmonary_details->name; ?>" class="st-tab">
              <div class="st-imagebox st-style2">
                <div class="row">
                  <div class="col-lg-6">
                    <div class="st-imagebox-img"><img style="height:400px; width:505px;" src="<?php echo $pulmonary_details->img; ?>" alt="service"></div>
                    <div class="st-height-b0 st-height-lg-b30"></div>
                  </div>
                  <div class="col-lg-6">
                    <div class="st-vertical-middle">
                      <div class="st-vertical-middle-in">
                        <div class="st-imagebox-info">
                        <h2 class="st-imagebox-title"><?php echo $pulmonary_details->designation; ?></span></h2>
                          <h4 class="st-imagebox-subtitle"><?php echo $pulmonary_details->crutches; ?> </h4>
                          <div class="st-imagebox-text"><?php echo $pulmonary_details->status; ?></div>
                        </div>
            ...
            <div id="<?php echo $cardiology_details->name; ?>" class="st-tab">
              <div class="st-imagebox st-style2">
                <div class="row">
                  <div class="col-lg-6">
                    <div class="st-imagebox-img"><img style="height:400px; width:505px;" src="<?php echo $cardiology_details->img; ?>" alt="service"></div>
                    <div class="st-height-b0 st-height-lg-b30"></div>
                  </div>
                  <div class="col-lg-6">
                    <div class="st-vertical-middle">
                      <div class="st-vertical-middle-in">
                        <div class="st-imagebox-info">
                        <h2 class="st-imagebox-title"><?php echo $cardiology_details->designation; ?></span></h2>
                          <h4 class="st-imagebox-subtitle"><?php echo $cardiology_details->crutches; ?> </h4>
                          <div class="st-imagebox-text"><?php echo $cardiology_details->status; ?></div>
                        </div>
            ...
            <div id="<?php echo $dental_details->name; ?>" class="st-tab">
              <div class="st-imagebox st-style2">
                <div class="row">
                  <div class="col-lg-6">
                    <div class="st-imagebox-img"><img style="height:400px; width:505px;" src="<?php echo $dental_details->img; ?>" alt="service"></div>
                    <div class="st-height-b0 st-height-lg-b30"></div>
                  </div>
                  <div class="col-lg-6">
                    <div class="st-vertical-middle">
                      <div class="st-vertical-middle-in">
                        <div class="st-imagebox-info">
                        <h2 class="st-imagebox-title"><?php echo $dental_details->designation; ?></span></h2>
                          <h4 class="st-imagebox-subtitle"><?php echo $dental_details->crutches; ?> </h4>
                          <div class="st-imagebox-text"><?php echo $dental_details->status; ?></div>
                        </div>
            ...
            <div id="<?php echo $neurology_details->name; ?>" class="st-tab">
              <div class="st-imagebox st-style2">
                <div class="row">
                  <div class="col-lg-6">
                    <div class="st-imagebox-img"><img style="height:400px; width:505px;" src="<?php echo $neurology_details->img; ?>" alt="service"></div>
                    <div class="st-height-b0 st-height-lg-b30"></div>
                  </div>
                  <div class="col-lg-6">
                    <div class="st-vertical-middle">
                      <div class="st-vertical-middle-in">
                        <div class="st-imagebox-info">
                        <h2 class="st-imagebox-title"><?php echo $neurology_details->designation; ?></span></h2>
                          <h4 class="st-imagebox-subtitle"><?php echo $neurology_details->crutches; ?> </h4>
                          <div class="st-imagebox-text"><?php echo $neurology_details->status; ?></div>
                        </div>
    ...
    <!-- End department Section -->
        ...
        <section id="appointment" class="st-shape-wrap st-gray-bg">
            ...
            <div class="container">
                <div class="st-section-heading st-style1">
                    <h2 class="st-section-heading-title">Get a Software For Your Hospital</h2>
                    <div class="st-seperator">
                        <div class="st-seperator-left wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s">
                        </div>
                        <div class="st-seperator-center"><img src="themes/assets/img/icons/plus.webp" alt="icon"></div>
                    ...
                    <div class="st-section-heading-subtitle"><?php echo $settings->registration_block_text; ?></div>
                </div>
                <div class="st-height-b40 st-height-lg-b40"></div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <form id="addNewHospital" enctype="multipart/form-data" method="post"
                            action="frontend/addNewHospitalPayment">
                            <div id="st-alert1"></div>
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="st-form-field st-style1">
                                        <label><?php echo lang('hospital'); ?> <?php echo lang('name'); ?> &ast;</label>
                                        <input type="text" name="name"
                                            placeholder="<?php echo lang('hospital'); ?> <?php echo lang('name'); ?> &ast;"
                                            required>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="st-form-field st-style1">
                                        <label><?php echo lang('hospital'); ?> <?php echo lang('address'); ?></label>
                                ...
                                <div class="col-lg-6">
                                    <div class="st-form-field st-style1">
                                        <label><?php echo lang('hospital'); ?> <?php echo lang('email'); ?></label>
                                ...
                                <div class="col-lg-6">
                                    <div class="st-form-field st-style1">
                                        <label><?php echo lang('hospital'); ?> <?php echo lang('phone'); ?></label>
                                        <input type="text" name="phone"
                                            placeholder="<?php echo lang('hospital'); ?> <?php echo lang('phone'); ?>"
                                            required>
                                    </div>
                                </div>

                                <div class="col-lg-6">
                                    <div class="st-form-field st-style1 package_select_div">
                                        <label><?php echo lang('package'); ?></label>
                                        <div class="st-custom-select-wrap">
                                            <select id="package_select" name="package" class="st_select1"
                                                data-placeholder="Select <?php echo lang('package'); ?>">
                                                <option><?php echo lang('select'); ?> <?php echo lang('package'); ?>
                                                </option>
                                ...
                                <div class="col-lg-6">
                                    <div class="st-form-field st-style1 package_duration_div">
                                        <label><?php echo lang('package'); ?></label>
                                        <div class="st-custom-select-wrap">
                                            <select id="package_duration" name="package_duration" class="st_select1"
                                                data-placeholder="Select <?php echo lang('package_duration'); ?>">
                                                <option><?php echo lang('select'); ?>
                                                    <?php echo lang('package_duration'); ?></option>
                                                <option value="<?php echo 'monthly'; ?>"><?php echo lang('monthly'); ?>
                                                </option>
                                                <option value="<?php echo 'yearly'; ?>"><?php echo lang('yearly'); ?>
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="st-form-field st-style1">
                                        <label><?php echo lang('package'); ?></label>
                                        <div class="st-custom-select-wrap">
                                            <select id="" name="language" class="st_select1"
                                                data-placeholder="Select <?php echo lang('language'); ?>">
                                                <option><?php echo lang('select'); ?> <?php echo lang('language'); ?>
                                                </option>
                                ...
                                <div class="col-lg-6">
                                    <div class="st-form-field st-style1">
                                        <label><?php echo lang('price'); ?> &ast;</label>
                                        <input class="price-input" type="text" name="price"
                                            placeholder="<?php echo lang('price'); ?> &ast;" required>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="st-form-field st-style1 country_div">
                                        <label><?php echo lang('country'); ?></label>
                                        <div class="st-custom-select-wrap">
                                            <select class="selectpicker countrypicker" data-live-search="true"
                                                data-flag="true" required="" name="country"
                                ...
                                <div class="col-lg-6">
                                    <div class="st-form-field st-style1">
                                        <label><?php echo lang('frontend_website_link'); ?> &ast;</label>
                                        <input class="" type="text" name="username" id="username"
                                            placeholder="<?php echo lang('frontend_website_link'); ?> &ast;" required>
                                    </div>
                                    <p id="web_link"></p>
                                </div>
                                ...
                                <div class="col-lg-6 payment_div">
                                    <div class="st-form-field st-style1">
                                        ...
                                        <select name="card_type" class="st_select1" data-placeholder="Select Card">
                                ...
                                <div class="col-lg-6 payment_div">
                                    <div class="st-form-field st-style1">
                                        <label><?php echo lang('expire'); ?>
                                            <?php echo lang('date'); ?></label>
                                        <input type="text" name="expire_date" id="expire" placeholder="Expiry (MM/YY)">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 payment_div">
                                    <div class="st-form-field st-style1">
                                        ...
                                        <input type="text" name="cvv_number" id="cvv"
...
<input type="hidden" name="recaptcha_response" id="recaptchaResponse">
                                ...
                                <div class="col-lg-12">
                                    <button type="submit" value="submit"
                                        class="st-btn st-style1 st-color1 st-size-medium submit_button" id="submit-btn"
                        ...
                        <div class="st-isotop-item <?php echo $image->position; ?>">
                            <a href="<?php echo $image->img; ?>" class="st-project st-zoom st-lightbox-item st-link-hover-wrap">
                                <div class="st-project-img st-zoom-in">
                                    ...
                                    <img style="height:286px; width:553px;" src="<?php echo $image->img; ?>" alt="project1">
                                        </div>
        ...
        <section class="st-before-after-section st-dynamic-bg st-bg" data-src="themes/assets/img/before-after-bg.jpg">
            ...
            <div class="container">
                <div class="st-section-heading st-style1">
                    <h2 class="st-section-heading-title"><?php echo $settings->market_title; ?></h2>
                    <div class="st-seperator">
                        <div class="st-seperator-left wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s">
                        </div>
                        <div class="st-seperator-center"><img src="themes/assets/img/icons/plus.webp" alt="icon"></div>
                    ...
                    <?php
          $text = $settings->market_description;
          $words = explode(' ', $text);
          $first_six_words = array_slice($words, 0, 12);
          $remaining_words = array_slice($words, 12);
          $first_section = implode(' ', $first_six_words);
                ...
                <div class="container">
                    <div class="st-before-after-in">
                        <div class="st-before-after">
                            <div class="st-after st-single-slide st-dynamic-bg"  data-src="<?php echo $settings->after_image; ?>">
                            </div>
                            <div class="st-before st-single-slide st-dynamic-bg" 
                                data-src="<?php echo $settings->before_image; ?>"></div>
        ...
        <section id="review">
            ...
            <div class="container">
                <div class="st-section-heading st-style1">
                    ...
                    <?php
          $text1 = $settings->review_text_under_title;
          $words1 = explode(' ', $text1);
          $first_six_words1 = array_slice($words1, 0, 12);
          $remaining_words1 = array_slice($words1, 12);
          $first_section1 = implode(' ', $first_six_words1);
                            ...
                            <div class="slick-slide-in">
                                <div class="st-testimonial st-style1 wow fadeInLeft" data-wow-duration="0.8s"
                                    ...
                                    <div class="st-testimonial-info">
                                        <div class="st-testimonial-img"><img style="height:90px; width:90px;" src="<?php echo $review->img; ?>"
                                                alt="avatar1"></div>
                    ...
                    <div class="col-xl-6 wow fadeInRight" data-wow-duration="0.8s" data-wow-delay="0.2s">
                        <div class="st-video-block st-style1 st-zoom">
                            <div class="st-video-block-img st-zoom-in st-dynamic-bg"
                                data-src="<?php echo $settings->team_review_logo; ?>"></div>
                            <a href="<?php echo $settings->team_button_link; ?>" class="st-play-btn st-style1 st-video-open">
                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
         ...
         <section id="price">
            ...
            <div class="container">
                <div class="st-section-heading st-style1">
                    ...
                    <?php
          $text1 = $settings->pricing_text_under_title;
          $words1 = explode(' ', $text1);
          $first_six_words1 = array_slice($words1, 0, 12);
          $remaining_words1 = array_slice($words1, 12);
          $first_section1 = implode(' ', $first_six_words1);
          ...
          ?>
                ...
                <div class="cd-pricing-switcher" id="fieldset_p">
                    <p class="fieldset">
                        <input type="radio" name="duration-1" class="duration" value="monthly" id="monthly-1"
                            checked="">
                            ...
                            <div class="slick-slide-in">
                                <div class="st-pricing-table st-style1">
                                    <div class="st-pricing-head">
                                        <h4 class="st-price text1">
                                            </span><?php echo ($settings->currency ?? '') . " " .  number_format((float) ($package1->monthly_price ?? 0), 2) ?>
                                        </h4>
                                        <h4 class="st-price text2 hidden">
                                            </span><?php echo ($settings->currency ?? '') . " " .  number_format((float) ($package1->yearly_price ?? 0), 2) ?>
                                        </h4>
                                        <img src="themes/assets/img/shape/price-shape.svg" alt="shape"
                                            class="st-pricing-head-shape">
                                    </div><!-- .st-pricing-head -->
                                    <div class="st-pricing-feature">
                                        <h1 <?php if ($package1->recommended == 'Yes') { ?> class="recommended_div"
                                            <?php } else { ?> class="recommended_div1" <?php } ?>>
                                            <?php echo $package1->name; ?> </h1>
                                        <?php $modules = explode(',', $package1->module); ?>
                                        <ul class="st-pricing-feature-list st-mp0"
                                            id="feature-list-<?php echo $package1->id; ?>">
                                            <?php
            for ($i = 0; $i < count($modules_list); $i++) {
                if (in_array($modules_list[$i], $modules)) {
                    $class = $i >= 5 ? 'hidden' : '';
                    ?>
                                            <li class="<?php echo $class; ?>"><i
                                                    class="fas fa-check"></i><?php echo $modules_list[$i]; ?></li>
                                            <?php
                } else {
                    $class = $i >= 5 ? 'hidden' : '';
                    ?>
                                            <li class="<?php echo $class; ?>"><i
                                                    class="fas fa-times"></i><?php echo $modules_list[$i]; ?></li>
                                            <?php
                }
            }
            ?>
                                            <li class="see-more" style="cursor: pointer; margin-top:50px; color:green;"
                                                data-id="<?php echo $package1->id; ?>"><i class="fas fa-chevron-down"></i>See
                                                More</li>

                                                <li class="see-less" style="cursor: pointer; margin-top:50px; color:blue;"
                                                data-id="<?php echo $package1->id; ?>"><i class="fas fa-chevron-up"></i>See
                                                Less</li>
                                        </ul>
                                        <div class="st-pricing-btn">
                                            <a href="#appointment"
                                                class="st-btn st-style2 st-color1 st-size-medium">Contact Now</a>
                                        </div>
                                        <div class="st-height-b30 st-height-lg-b30"></div>
                                        <!-- <button class="see-more st-btn st-style2 st-color1 st-size-medium" data-id="<?php echo $package1->id; ?>"></button> -->
                                    </div>
                                </div>
                            </div><!-- .slick-slide-in -->
                            <?php
        ...
        <section class="st-faq-wrap st-shape-wrap">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <h2 class="st-accordian-heading">Frequently asked questions (FAQs)</h2>
                        <div class="st-accordian-wrap">
                            ...
                            <div class="st-accordian">
                                ...
                                <div class="st-accordian-body"><?php echo $faq->description; ?></div>
                            </div><!-- .st-accordian -->
                            <?php } ?>
...
.see-less {
    display: none;
                    ...
                    <div class="col-lg-4">
                        <div class="st-post st-style3">
                            <a href="<?php echo $blog->button_link; ?>" class="st-post-thumb st-link-hover-wrap st-zoom">
                                <img class="st-zoom-in" style="height:242px; width:358px;" src="<?php echo $blog->img_url; ?>" alt="blog1">
                                <span class="st-link-hover"><i class="fas fa-link"></i></span>
                            </a>
                            <div class="st-post-info">
                                <h2 class="st-post-title"><a
                                        href="#"><?php echo $blog->title; ?></a></h2>
                                <div class="st-post-meta">
                                    <span class="st-post-date"><?php echo date('d-m-Y', $blog->date); ?></span>
                                    <span>
                                        Posted by:<a href="#" class="st-post-avatar">
                                            <span class="st-post-avatar-text"> <?php echo $blog->posted_by; ?></span>
                                        </a>
                                    </span>
                                </div>
                                <div class="st-post-text"><?php echo $blog->description; ?></div>
                            </div>
        ...
        <!-- Start News Letter -->
        <section class="st-news-letter-section st-dynamic-bg st-bg" data-src="themes/assets/img/news-letter-bg.png">
            <div class="container">
                <div class="st-section-heading st-style1">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="st-news-letter">
                            <form class="st-news-letter-form" action="frontend/addSubscribe" method="post">
                            ...
                            <div class="st-news-letter-number"><?php echo $settings->phone; ?></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section id="service">
            ...
            <div class="container">
                <div class="st-section-heading st-style1">
                    <h2 class="st-section-heading-title"><?php echo lang('our_service'); ?></h2>
                    <div class="st-seperator">
                        <div class="st-seperator-left wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s">
                        </div>
                        <div class="st-seperator-center"><img src="themes/assets/img/icons/plus.webp" alt="icon"></div>
                    ...
                    <div class="st-section-heading-subtitle"><?php echo $settings->service_block__text_under_title; ?>
                    </div>
                </div>
                <div class="st-height-b40 st-height-lg-b40"></div>
            </div>
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="st-post st-style3">
                            <a href="<?php echo $service->button_link; ?>" class="st-post-thumb st-link-hover-wrap st-zoom">
                                <img class="st-zoom-in" style="height:242px; width:358px;" src="<?php
                            ...
                            <div class="st-post-info">
                                <h2 class="st-post-title"><a href="#"><?php echo $service->title; ?></a></h2>

                                <div class="st-post-text"><?php echo $service->description; ?></div>
                            </div>
        ...
        <section class="st-shape-wrap" id="contact">
            <div class="st-shape1"><img src="themes/assets/img/shape/contact-shape1.svg" alt="shape1"></div>
            <div class="st-shape2"><img src="themes/assets/img/shape/contact-shape2.svg" alt="shape2"></div>
            <div class="st-height-b120 st-height-lg-b80"></div>
            <div class="container">
                <div class="st-section-heading st-style1">
                    ...
                    <div class="st-section-heading-subtitle"><?php echo $settings->contact_us; ?></div>
                </div>
                <div class="st-height-b40 st-height-lg-b40"></div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <div id="st-alert"></div>
                        <form action="frontend/send" id="sendEmail" class="row st-contact-form st-type1" method="post">
                            <div class="col-lg-6">
                                <div class="st-form-field st-style1">
                            ...
                            <div class="col-lg-6">
                                <div class="st-form-field st-style1">
                                    ...
                                    <input type="text" id="email" name="other_email" placeholder="Email" required>
                                </div>
                            </div><!-- .col -->
                            <div class="col-lg-6">
                                <div class="st-form-field st-style1">
                                    <label><?php echo lang('hospital'); ?>
                                        <?php echo lang('name'); ?></label>
                                    <input type="text" id="subject" name="hospital_name"
                                        placeholder="<?php echo lang('hospital'); ?>
                                                                                            <?php echo lang('name'); ?>" required>
                                </div>
                            </div><!-- .col -->
                            <div class="col-lg-6">
                                <div class="st-form-field st-style1">
                                    <label>Phone</label>
                                    <input type="text" id="phone" name="phone" placeholder="Phone (Ex. +1-234-567-890)"
                                        required>
                                </div>
                            </div><!-- .col -->
                            <div class="col-lg-12">
                    ...
                    <div class="col-lg-3">
                        <div class="st-footer-widget">
                            <div class="st-text-field">
                                <img src="<?php echo $settings->logo ; ?>" alt="Nischinto" width="100"
                                    class="st-footer-logo">
                                <div class="st-height-b25 st-height-lg-b25"></div>
                                <div class="st-footer-text">Our focus is on your overall well being and helping you
                                    achieve optimal health
                                    and esthetics.
                                    We provide state of the art dental care.
                                    <br />
                                </div>
                                <div class="st-height-b25 st-height-lg-b25"></div>
                                <ul class="st-social-btn st-style1 st-mp0">
                    ...
                    <div class="col-lg-3">
                        <div class="st-footer-widget">
                            ...
                            <ul class="st-footer-widget-nav st-mp0">
                                ...
                                <li><a href="#price"><i class="fas fa-chevron-right"></i>Pricing</a></li>
                                <li><a href="#service"><i class="fas fa-chevron-right"></i>Service</a></li>
                                <li><a href="#review"><i class="fas fa-chevron-right"></i>Review</a></li>
                    ...
                    <div class="col-lg-3">
                        <div class="st-footer-widget">
                            ...
                            <ul class="st-footer-widget-nav st-mp0">
                                ...
                                <li><a href="#"><i class="fas fa-chevron-right"></i>Terms & Condition</a></li>
    ...
    <script src="themes/assets/js/YTPlayer.min.js"></script>
...
document.querySelectorAll('.see-more').forEach(function(button) {
    button.addEventListener('click', function() {
        ...
        var hiddenItems = document.querySelectorAll('#feature-list-' + id + ' .hidden');
        hiddenItems.forEach(function(item) {
            item.classList.remove('hidden');
        });
        this.style.display = 'none';
        document.querySelector('#feature-list-' + id + ' .see-less').style.display = 'block';
    });
});
...
document.querySelectorAll('.see-less').forEach(function(button) {
    button.addEventListener('click', function() {
        var id = this.getAttribute('data-id');
        var allItems = document.querySelectorAll('#feature-list-' + id + ' li');
        ...
        this.style.display = 'none';
        document.querySelector('#feature-list-' + id + ' .see-more').style.display = 'block';
    });
});
</script>
    <script>
    document.addEventListener('DOMContentLoaded', function() {
        // Initially activate the first FAQ row and close the rest
        const faqRows = document.querySelectorAll('.st-accordian');
        if (faqRows.length > 0) {
            faqRows[0].classList.add('active');
            faqRows[0].querySelector('.st-accordian-body').style.display = 'block';
            for (let i = 1; i < faqRows.length; i++) {
                faqRows[i].classList.remove('active');
                faqRows[i].querySelector('.st-accordian-body').style.display = 'none';
            }
        }

        // Add click event listeners to all FAQ rows
        faqRows.forEach(function(accordian) {
            accordian.addEventListener('click', function() {
                // Remove active class from all FAQ rows
                faqRows.forEach(function(item) {
                    item.classList.remove('active');
                    item.querySelector('.st-accordian-body').style.display = 'none';
                });
                // Add active class to the clicked FAQ row
                this.classList.add('active');
                this.querySelector('.st-accordian-body').style.display = 'block';
            });
        });
    });
    </script>
