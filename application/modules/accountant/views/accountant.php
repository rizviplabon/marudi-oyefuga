                ...
                <div class="row">
                        ...
                        <div class="card">
                            <div class="card-header table_header">
                                        <h4 class="card-title mb-0 col-lg-8"><?php echo lang('accountant'); ?></h4> 
                                        <div class="col-lg-4 no-print pull-right"> 
                                        <button type="button" class="btn btn-info waves-effect waves-light w-xs" data-bs-toggle="modal"
                                                    data-bs-target="#myModal"><i class="fa fa-plus-circle"></i> <?php echo lang('add_accountant'); ?></button>
                            ...
                            <?php foreach ($accountants as $accountant) { ?>
                                <tr class="">
                                    ...
                                    <?php
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        <a class="dropdown-item editbutton" data-toggle="modal"
                                                            data-id="<?php echo $accountant->id; ?>">Edit</a>
                                                        <a class="dropdown-item"
                                                            href="accountant/delete?id=<?php echo $accountant->id; ?>"
                                        ...
                                        <?php } else { ?>
                                    <td class="no-print">
                                        <button type="button" class="btn btn-info  waves-effect waves-light btn-xs editbutton" title="<?php echo lang('edit'); ?>" data-toggle="modal" data-id="<?php echo $accountant->id; ?>"><i class="fa fa-edit"> </i></button>   
                                        <a class="btn btn-info btn-xs  waves-effect waves-light delete_button" title="<?php echo lang('delete'); ?>" href="accountant/delete?id=<?php echo $accountant->id; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash"> </i></a>
                                    </td>
                                    <?php } ?>
                                </tr>
                            <?php } ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h5 class="modal-title">  <?php echo lang('add_accountant'); ?></h5>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h5 class="modal-title">  <?php echo lang('edit_accountant'); ?></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
