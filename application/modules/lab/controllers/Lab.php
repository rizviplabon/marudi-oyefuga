...
class Lab extends MX_Controller
{
                                ...
                                <td>
                                    <table style="margin-top: 10px;">
                                        ...
                                        <tr>
                                            ...
                                            <td><label class="control_label">VN Date</label> <span class="info_text">:
                                                                                                                        ' . $datess . '</span></td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">
    ...
    function getTestStatusLab2()
    {
        ...
        foreach ($data['labs'] as $lab) {
            ...
            if ($this->ion_auth->in_group(array('admin', 'Laboratorist', 'Doctor'))) {
                $options1 = ' <a class="btn btn-soft-info btn-xs editbutton" title="' . lang('edit') . '" href="lab?id=' . $lab->id . '"><i class="fa fa-edit"> </i> ' . lang('') . '</a>';
            } else {
                $options1 = '';
            }

            $options2 = '<a class="btn btn-soft-primary btn-xs invoicebutton" title="' . lang('lab') . '"  href="lab/invoice?id=' . $lab->id . '"><i class="fa fa-file"></i> ' . lang('') . '</a>';
            $options2 = '<a class="btn btn-soft-primary btn-xs invoicebutton" title="Download PDF" target="_blank"  href="lab/viewReport?id=' . $lab->id . '"><i class="fas fa-eye"></i></a>'
                . '<a class="btn  btn-soft-primary btn-xs invoicebutton" title="Download PDF"  href="lab/testPdf?id=' . $lab->id . '"> PDF</a>';
            if ($this->ion_auth->in_group(array('admin', 'Doctor', 'Laboratorist'))) {
                $options3 = '<a class="btn btn-soft-danger btn-xs delete_button" title="' . lang('delete') . '" href="lab/delete?id=' . $lab->id . '" onclick="return confirm(\'Are you sure you want to delete this item?\');"><i class="fa fa-trash"></i>' . lang('') . '</a>';
            } else {
                $options3 = '';
            }
            ...
            if ($lab->status == 'sample_taken') {
                $status = '<span class="badge bg-primary">' . lang('sample_collected') . '</span>';
            } elseif ($lab->status == 'complete') {
                $status = '<span class="badge bg-info">' . lang('report') . " " . lang('completed') . '</span>';
            } elseif ($lab->status == 'waiting') {
                $status = '<span class="badge bg-danger">' . lang('sample_not_collected') . '</span>';
            } elseif ($lab->status == 'pending') {
                $status = '<span class="badge bg-warning">' . lang('report') . " " . lang('pending') . '</span>';
            } elseif ($lab->status == 'delivery_pending') {
                $status = '<span class="badge bg-danger">' . lang('delivery') . " " . lang('pending') . '</span>';
            } else {
    ...
    function getTestStatusLab()
    {
        ...
        foreach ($data['labs'] as $lab) {
            ...
            $options2 = '<a class="btn btn-soft-primary btn-xs invoicebutton" title="' . lang('lab') . '"  href="lab/invoice?id=' . $lab->id . '"><i class="fa fa-file"></i> ' . lang('') . '</a>';
            $options2 = '<a class="btn btn-soft-primary btn-xs invoicebutton" title="Download PDF"  href="lab/testPdf?id=' . $lab->id . '">PDF</a>';
            $option = '<a class="btn btn-soft-primary btn-xs btn-success invoicebutton" style="margin-right: 10px" target="_blank" href="lab/printLabel?id=' . $lab->id . '">' . lang('label_print') . '</a>
            <a class="btn btn-xs btn-soft-warning" href="lab/pdfLabel?id=' . $lab->id . '".><i class="fas fa-file-pdf"></i></a>';
            ...
            if($this->ion_auth->in_group('admin')){
                if($this->settings->dashboard_theme =='main'){
                    ...
                    $all_options .= '<a class="dropdown-item invoicebutton"target="_blank" href="lab/printLabel?id=' . $lab->id . '">' . lang('label_print') . '</a>
                    <a class="dropdown-item" href="lab/pdfLabel?id=' . $lab->id . '".><i class="fas fa-file-pdf"></i></a>';
    ...
    function getLab()
    {
        ...
        foreach ($data['labs'] as $lab) {
            ...
            $date = date('d-m-y', $lab->date);
            if ($this->ion_auth->in_group(array('admin', 'Laboratorist', 'Doctor'))) {
                $options1 = ' <a class="btn btn-soft-info btn-xs editbutton" title="' . lang('report') . '" href="lab?id=' . $lab->id . '"><i class="fa fa-edit"> </i> ' . lang('report') . '</a>';
            } else {
                $options1 = '';
            }

            $options2 = '<a class="btn btn-soft-primary btn-xs invoicebutton" title="' . lang('lab') . '"  href="lab/invoice?id=' . $lab->id . '"><i class="fa fa-file"></i> ' . lang('') . '</a>';
            $options2 = '<a class="btn btn-soft-primary btn-xs invoicebutton" title="Download PDF" target="_blank" style=" margin-right: 5px" href="lab/viewReport?id=' . $lab->id . '"><i class="fas fa-eye"></i> ' . lang('view') . '</a>'
                . '<a class="btn btn-soft-info btn-xs invoicebutton" title="Download PDF" style=" margin-right: 5px" href="lab/testPdf?id=' . $lab->id . '"> <i class="fas fa-file-pdf"></i> PDF</a>';


            // $options2 = '<a class="btn btn-xs invoicebutton" title="Download PDF" target="_blank" style=" margin-right: 5px" href="lab/viewReport?id=' . $lab->id . '"><i class="fas fa-eye"></i> ' . lang('view') . '</a>'
            // . '<a class="btn btn-xs invoicebutton" title="Download PDF" style=" margin-right: 5px" href="lab/testPdf?id=' . $lab->id . '"> <i class="fas fa-file-pdf"></i> PDF</a>'
            // . '<a class="btn btn-xs invoicebutton" title="Download Word" style=" margin-right: 5px" href="lab/makeWord?id=' . $lab->id . '">  <i class="fas fa-file-word"></i> Word</a>';
            ...
            if ($this->ion_auth->in_group(array('Laboratorist'))) {
                $options3 = '<a class="btn btn-soft-success btn-xs signBtn" href="lab/signLab?id=' . $lab->id . '">Sign</a>';
            }
            if($this->ion_auth->in_group('admin')){
                if($this->settings->dashboard_theme =='main'){
                    $all_options = '<div class="btn-group">
                   ...
                   $all_options.= '<a class="dropdown-item editbutton" href="lab?id=' . $lab->id . '">'. lang('report'). '</a>
                   <a class="dropdown-item editbutton" target="_blank" href="lab/viewReport?id=' . $lab->id . '">'. lang('view'). '</a>
                      <a class="dropdown-item editbutton" href="lab/testPdf?id=' . $lab->id . '">PDF</a>'
                      ;
            ...
            $status = "";
            if ($lab->status == "pending") {
                $status = '<span class="badge bg-danger">' . lang('pending') . '</span>';
            } else if ($lab->status == "drafted") {
                $status = '<span class="badge bg-warning">' . lang('drafted') . '</span>';
            } else {
        ...
        if (!empty($data['labs'])) {
            $output = array(
                "draw" => intval($requestData['draw']),
                "recordsTotal" => count($this->lab_model->getLabReport($status, $category, $from, $to)),
                "recordsFiltered" => $i,
                "data" => $info
            );
        } else {
    ...
    function getTemplate()
    {
        ...
        foreach ($data['templates'] as $template) {
            $i = $i + 1;
            $option1 = '<a href="lab/editTemplate?id=' . $template->id . '" class="btn btn-soft-info btn-xs btn_width editbutton" title="' . lang('edit') . '" data-toggle="modal" data-id="' . $template->id . '"><i class="fa fa-edit"> </i></a>';
            $option2 = '<a class="btn btn-soft-danger btn-xs btn_width delete_button" title="' . lang('delete') . '" href="lab/deleteTemplate?id=' . $template->id . '" onclick="return confirm("Are you sure you want to delete this item?");"><i class="fa fa-trash"> </i></a>';
            if($this->ion_auth->in_group('admin')){
                if($this->settings->dashboard_theme =='main'){
                    $all_options = '<div class="btn-group">
                    <a class="hover-primary dropdown-toggle no-caret" data-bs-toggle="dropdown"><i class="fa fa-ellipsis-h"></i></a>
                   ...
                   $all_options.= '<a class="dropdown-item editbutton" href="lab/editTemplate?id=' . $template->id . '">'. lang('edit'). '</a>

                      <a class="dropdown-item" href="lab/deleteTemplate?id=' . $template->id . '" onclick="return confirm(\'Are you sure you want to delete this item?\');">'. lang('delete'). '</a>';
    ...
    function getDeliveryReport()
    {
        ...
        foreach ($data['labs'] as $lab) {
            ...
            $date = date('d-m-y', $lab->date);
            if ($this->ion_auth->in_group(array('admin', 'Laboratorist', 'Doctor'))) {
                $options1 = ' <a class="btn btn-soft-info btn-xs editbutton" title="' . lang('edit') . '" href="lab?id=' . $lab->id . '"><i class="fa fa-edit"> </i> ' . lang('report') . '</a>';
            } else {
                $options1 = '';
            }

            $options2 = '<a class="btn btn-soft-primary btn-xs invoicebutton" title="' . lang('lab') . '"  href="lab/invoice?id=' . $lab->id . '"><i class="fa fa-file"></i> ' . lang('view') . '</a>';
            $options2 = '<a class="btn btn-soft-primary btn-xs invoicebutton" title="Download PDF"  href="lab/viewReport?id=' . $lab->id . '"><i class="fa fa-eye"></i> '.lang('view').'</a>'
                . '<a class="btn btn-soft-primary btn-xs invoicebutton" title="Download PDF"  href="lab/testPdf?id=' . $lab->id . '"> <i class="fa fa-file-pdf"></i> PDF</a>';

            // $options2 = '<a class="btn btn-xs invoicebutton" title="Download PDF"  href="lab/viewReport?id=' . $lab->id . '"><i class="fas fa-eye"></i></a>'
            //     . '<a class="btn btn-xs invoicebutton" title="Download PDF"  href="lab/testPdf?id=' . $lab->id . '"> PDF</a>'
            //     . '<a class="btn btn-xs invoicebutton" title="Download Word" style=" margin-right: 5px" href="lab/makeWord?id=' . $lab->id . '"> Word</a>';
            ...
            if ($lab->delivery_status == 'pending' || ($lab->delivery_status == 'delivered' && $lab->receiver_name == null)) {
                $options3 .= ' <a class="btn btn-soft-success btn-xs changeDeliveryStatus" data-id="' . $lab->id . '"><i class="fas fa-check"></i> '.lang('deliver').'</a>';
            } else {
                $options3 .= ' <a class="btn btn-soft-success btn-xs changeDeliveryStatus" data-id="' . $lab->id . '"><i class="fas fa-check"></i> '.lang('deliver').'</a>';
            }
            if($this->ion_auth->in_group('admin')){
                if($this->settings->dashboard_theme =='main'){
                   ...
                   $all_options.= '<a class="dropdown-item editbutton" href="lab?id=' . $lab->id . '">'. lang('report'). '</a>
                   <a class="dropdown-item editbutton" href="lab/viewReport?id=' . $lab->id . '">'. lang('view'). '</a>
                      <a class="dropdown-item editbutton" href="lab/testPdf?id=' . $lab->id . '">PDF</a>
                      ';
                      if ($lab->delivery_status == 'pending' || ($lab->delivery_status == 'delivered' && $lab->receiver_name == null)) {
                        $all_options .= ' <a class="dropdown-item changeDeliveryStatus" data-id="' . $lab->id . '"> '.lang('deliver').'</a>';
                    } else {
                        $all_options .= ' <a class="dropdown-item changeDeliveryStatus" data-id="' . $lab->id . '"> '.lang('deliver').'</a>';
                    }
               $all_options.= '</div>
            ...
            //            if ($lab->delivery_status == "pending") {
            //                $status .= '<span class="badge bg-warning">' . lang('pending') . '</span>';
            //            } else if ($lab->delivery_status == "delivered") {
            //                $status = '<span class="badge bg-success">' . lang('delivered') . '</span>';
            //                //$status .= '<span class="badge bg-success">' . lang('delivered') . '</span>';
            //            }
            ...
            $info[] = array(
                ...
                $status,
                $lab->delivery_status_date != null ? date('d-m-y h:i A', $lab->delivery_status_date) : "",
                $lab->receiver_name,
                $bill_status,
                $all_options,
            );
    ...
    function getLab2()
    {
        ...
        foreach ($data['labs'] as $lab) {
            ...
            $options2 = '<a class="btn btn-soft-primary btn-xs invoicebutton" title="' . lang('lab') . '"  href="lab/invoice?id=' . $lab->id . '"><i class="fa fa-file"></i> ' . lang('') . '</a>';
            $options2 = '<a class="btn btn-soft-primary btn-xs invoicebutton" title="Download PDF"  href="lab/testPdf?id=' . $lab->id . '"><i class="fas fa-eye"></i> PDF</a>';
    ...
    function getMyLab()
    {
        ...
        foreach ($data['labs'] as $lab) {
            ...
            $options2 = '<a class="btn btn-soft-primary btn-xs invoicebutton" title="' . lang('lab') . '"  href="lab/invoice?id=' . $lab->id . '"><i class="fa fa-file"></i> ' . lang('') . '</a>';
            $options2 = '<a class="btn btn-soft-primary btn-xs invoicebutton" title="Download PDF" style=" margin-right: 5px" href="lab/testPdf?id=' . $lab->id . '"> PDF</a>';
            ...
            $options3 = "";
            if ($this->ion_auth->in_group(array('Laboratorist'))) {
                $options3 = '<a class="btn btn-success btn-xs signBtn" href="lab/signLab?id=' . $lab->id . '">Sign</a>';
            }
    ...
    public function encrypt_lab_data() {
        ...
        $encrypted_fields = $this->lab_model->encrypted_fields;
        $total_count = count($labs);
        $success_count = 0;
        $encrypted_fields_count = array_fill_keys($encrypted_fields, 0);
        
        // Re-encrypt all lab data with our approach
        foreach ($labs as $lab) {
            if (empty($lab->id)) {
                continue;
            }
        ...
        // Output the results
        echo "<h2>Lab Data Encryption Results</h2>";
        echo "<p>Successfully updated {$success_count} out of {$total_count} lab records.</p>";
