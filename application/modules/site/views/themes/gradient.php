...
<head>
  ...
  ?>
    ...
    <!-- Favicon Icon -->
    <link rel="icon" href="themes/assets/img/icons/plus.webp" />
    <!-- Stylesheets -->
    <link rel="stylesheet" href="themes/assets/css/bootstrap.min.css" />
    <link rel="stylesheet" href="themes/assets/css/fontawesome.css" />
    <link rel="stylesheet" href="themes/assets/css/slick.css" />
    <link rel="stylesheet" href="themes/assets/css/lightgallery.min.css" />
    <link rel="stylesheet" href="themes/assets/css/animate.css" />
    <link rel="stylesheet" href="themes/assets/css/jQueryUi.min.css" />
    <link rel="stylesheet" href="themes/assets/css/textRotate.css" />
    <link rel="stylesheet" href="themes/assets/css/select2.min.css" />
...
<body>
                ...
                <div class="st-top-header-in">
                    <ul class="st-top-header-list">
                        <li>
                            ...
                            <a
                                href="site/<?php echo $this->session->userdata('site_name'); ?>#"><?php echo $settings->email; ?></a>
                        </li>
                        <li>
                            ...
                            <a
                                href="site/<?php echo $this->session->userdata('site_name'); ?>#"><?php echo $settings->phone; ?></a>
                        </li>
                    </ul>
            ...
            <div class="container">
                <div class="st-main-header-in">
                    <div class="st-main-header-left">
                        <a class="st-site-branding" href="site/<?php echo $this->session->userdata('site_name'); ?>">
              ...
              if(!empty($settings)){
                if (!empty($settings->logo)) {
                  if (file_exists($settings->logo)) {
                    echo '<img width="50" src=' . $settings->logo . '>';
                  } else {
              ...
              ?>
                    ...
                    <div class="st-main-header-right">
                        <div class="st-nav">
                            <ul class="st-nav-list st-onepage-nav">
                                <li><a href="site/<?php echo $this->session->userdata('site_name'); ?>#home"
                                        class="st-smooth-move">Home</a></li>
                                <li><a href="site/<?php echo $this->session->userdata('site_name'); ?>#about"
                                        class="st-smooth-move">About</a></li>
                                <li><a href="site/<?php echo $this->session->userdata('site_name'); ?>#department"
                                        class="st-smooth-move">Department</a></li>
                                <li><a href="site/<?php echo $this->session->userdata('site_name'); ?>#doctors"
                                        class="st-smooth-move">Doctors</a></li>
                                <li><a href="site/<?php echo $this->session->userdata('site_name'); ?>#gallery"
                                        class="st-smooth-move">Gallery</a></li>
                                <li><a href="site/<?php echo $this->session->userdata('site_name'); ?>#review"
                                        class="st-smooth-move">Reviews</a></li>
                                <!-- <ul>
                    ...
                    <li><a href="blog-details-no-sidebar.html">Blog Details No Sidebar</a></li>
                                ...
                                <!-- </li> -->
                                <li><a href="auth/login" target="_blank" class="st-smooth-move">Login</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <div class="st-content">
        ...
        <div class="st-hero-wrap overflow-hidden st-gradient">
          ...
          $text = $slide->title;
          $words = explode(' ', $text);
          $first_six_words = array_slice($words, 0, 3);
          $remaining_words = array_slice($words, 3);
          $first_section = implode(' ', $first_six_words);
          $second_section = implode(' ', $remaining_words);
          $text3 = $second_section;
          $words = explode(' ', $text3);
          if (count($words) >= 3) {
            $words[3] = '<span class="cd-words-wrapper"><b class="is-visible">' . $words[3] . '</b></span>';
        }
        
        $styled_text = implode(' ', $words);
          ?>
          <?php
          $text1 = $slide->text1;
          ...
          ?>
                        <h1 class="st-hero-title cd-headline slide">
                            ...
                            <br>
                            <?php echo $styled_text; ?>
                        </h1>
                        <div class="st-hero-subtitle"><?php echo $first_section1; ?> <br> <?php echo $second_section1; ?></div>
                        <div class="st-hero-btn-group">
                            <a href="#appointment" class="st-btn st-style1 st-color5 st-smooth-move">Appointment</a>
                            <a href="#about" class="st-btn st-style2 st-color2 st-smooth-move">About Us</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="slick-wrapper">
                        <div class="slick-slide-in">
                            <div class="st-hero-img">
                                <img src="<?php echo $slide->img_url; ?>" alt="Hero img">
                            </div>
                        </div>

                    </div>
                </div><!-- .slick-container -->
                <div class="pagination st-style1 container st-hidden"></div>
                ...
                <div class="row">
                    <div class="col-lg-4">
                      ...
                      s-23.8-10.676-23.8-23.8c0-13.124,10.677-23.8,23.8-23.8S389.001,385.251,389.001,398.375z" />
                            ...
                            <div class="st-iconbox-text">Our team consists of highly qualified and experienced doctors
                                dedicated to providing the best care possible.</div>
                        </div>
                    ...
                    <div class="col-lg-4">
                        <div class="st-iconbox st-style1">
                            ...
                            <div class="st-iconbox-text">Round-the-clock medical assistance and emergency services to
                                support you whenever you need us.</div>
                        </div>
                        <div class="st-height-b0 st-height-lg-b30"></div>
                    </div><!-- .col -->
                    <div class="col-lg-4">
                        <div class="st-iconbox st-style1">
                            ...
                            <div class="st-iconbox-text">We have a team of highly skilled emergency physicians, we
                                provide rapid of medical emergencies</div>
                        </div>
                        <div class="st-height-b0 st-height-lg-b30"></div>
                    </div><!-- .col -->
                </div>
        ...
        <section class="st-about-wrap" id="about">
            ...
            <div class="container">
                <div class="st-section-heading st-style1">
                    ...
                    <?php
          $text = $settings->appointment_title;
          $words = explode(' ', $text);
                        ...
                        <div class="st-vertical-middle">
                            <div class="st-vertical-middle-in">
                                <div class="st-text-block st-style1">
                                    <h2 class="st-text-block-title"><?php echo $settings->appointment_subtitle; ?></h2>
                                    <div class="st-height-b20 st-height-lg-b20"></div>
                                    <div class="st-text-block-text">
                                        <p><?php echo $settings->appointment_description; ?></p>
                                    </div>
                                    <div class="st-height-b25 st-height-lg-b25"></div>
                                    <div class="st-text-block-avatar">
                                        <div class="st-avatar-img"><img
                                                src="<?php echo $settings->appointment_img_url; ?>" alt="avatar"></div>
                    ...
                    <div class="col-lg-5 wow fadeInRight" data-wow-duration="0.8s" data-wow-delay="0.2s">
                        <div class="st-shedule-wrap">
                            <div class="st-shedule">
                                ...
                                <ul class="st-shedule-list">
                                    ...
                                    <li>
                                        <div class="st-shedule-left"><?php echo $gridsection->title; ?></div>
                                        <div class="st-shedule-right"><?php echo $gridsection->category; ?> </div>
                                    </li>
                                    <?php } ?>
                      ...
                      c8.481,0,15.354-6.875,15.356-15.354C356.215,211.732,348.444,192.968,333.737,178.26z" />
                                    ...
                                    <div class="st-call-text">
                                        ...
                                        <div class="st-call-number"><?php echo $settings->phone; ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <section id="department">
            ...
            <div class="container">
                <div class="st-section-heading st-style1">
                    ...
                    <div class="st-section-heading-subtitle">Welcome to our Department. Our dedicated team of
                        professionals is committed to <br> providing
                        comprehensive healthcare services to our community.</div>
                </div>
                <div class="st-height-b40 st-height-lg-b40"></div>
            </div>
            <div class="container">
        ...
        <section id="appointment" class="st-shape-wrap st-gray-bg">
            <div class="st-shape4">
                <img src="themes/assets/img/shape/section_shape.png" alt="shape1">
            </div>
            <div class="st-shape6">
                <img src="themes/assets/img/shape/contact-shape3.svg" alt="shape3">
            </div>
            <div class="st-height-b120 st-height-lg-b80"></div>
            <div class="container">
                <div class="st-section-heading st-style1">
                    ...
                    <?php
          $text = $settings->appointment_block_text_under_title;
          $words = explode(' ', $text);
          $first_six_words = array_slice($words, 0, 12);
          $remaining_words = array_slice($words, 12);
          $first_section = implode(' ', $first_six_words);
                ...
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <form action="site/addNew" method="post" id="addAppointmentForm">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="st-form-field st-style1 st-color2">
                                        <label>Patient</label>
                                        <select class="form-control m-bot15 js-example-basic-single pos_select"
                                            id="pos_select" name="patient" value=''>
                                            <option value=" ">Select Type</option>
                                            <option class="patient_add" value="patient_id">
                                                <?php echo lang('patient_id'); ?></option>
                                            <option class="patient_add_new" value="add_new">
                                                <?php echo lang('add_new'); ?></option>
                                        </select>
                                    </div>
                                </div>

                                <div class="col-lg-6 pos_client_id">
                                    <div class="st-form-field st-style1 st-color2">
                                        <label>Patient Id</label>
                                        <input type="text" class="form-control pay_in" name="patient_id"
                                            placeholder="Patient Id">
                                    </div>
                                </div>


                                <div class="col-lg-6 pos_client">
                                    <div class="st-form-field st-style1 st-color2">
                                        <label>Full Name</label>
                                        <input type="text" id="" name="p_name" placeholder="Full Name">
                                    </div>
                                </div>
                                <div class="col-lg-6 pos_client">
                                    <div class="st-form-field st-style1 st-color2">
                                        <label>Email</label>
                                        <input type="text" id="" name="p_email" placeholder="Email address">
                                    </div>
                                </div>
                                <div class="col-lg-6 pos_client">
                                    <div class="st-form-field st-style1 st-color2">
                                        <label>Phone</label>
                                        <input type="text" id="" name="p_phone" placeholder="Phone number">
                                    </div>
                                </div>
                                <div class="col-lg-6 pos_client">
                                    <div class="st-form-field st-style1 st-color2">
                                ...
                                <div class="doctor_div col-lg-6">
                                    <div class="st-form-field st-style1 st-color2">
                                        <label>Doctor</label>
                                        <div class="st-custom-select-wrap">
                                            <select class="st_select1" name="doctor" id="adoctors"
                                ...
                                <div class="col-lg-6">
                                    <div class="st-form-field st-style1">
                                        ...
                                        <input name="date" class="default-date-picker" type="text" id="date"
                                ...
                                <div class="col-lg-6">
                                    <div class="st-form-field st-style1 st-color2">
                                        ...
                                        <div class="st-custom-select-wrap">
                                            <select name="time_slot" class="st_select1" id="aslots"
                                ...
                                <div class="col-lg-6">
                                    <div class="st-form-field st-style1 st-color2">
                                        ...
                                        <div class="st-custom-select-wrap">
                                            <select name="visit_description" class="st_select1" id="visit_description"
                                                data-placeholder="Select Visit Type">
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="st-form-field st-style1 st-color2">
                                        ...
                                        <input type="text" id="visit_charges" name="visit_charges"
                                ...
                                <div class="col-lg-12">
                                    <div class="st-form-field st-style1">
                                        <label>Remarks</label>
                                        <textarea cols="30" rows="10" id="remarks" name="remarks"
                            ...
                            <div class="slick-slide-in">
                                <div class="st-member st-style1 st-zoom">
                                    <div class="st-member-img">
                                        <img src="<?php echo $featured->img_url; ?>" alt="" class="st-zoom-in">
                                        <a class="st-doctor-link"><i class="fas fa-link"></i></a>
                                        <div class="st-member-social-wrap">
                                            <img src="themes/assets/img/shape/member-shape.svg" alt="shape"
                                                class="st-member-social-bg">
                                            <ul class="st-member-social st-mp0">
                                                <li><a
                                                        href="site/<?php echo $this->session->userdata('site_name'); ?>#"><i
                                    ...
                                    <div class="st-member-meta">
                                        <div class="st-member-meta-in">
                                            <h3 class="st-member-name"><a
                                                    href="doctor-profile.html"><?php echo $featured->name; ?></a></h3>
        ...
        <section id="gallery">
            ...
            <div class="container">
                <div class="st-section-heading st-style1">
                    ...
                    <div class="st-section-heading-subtitle"><?php echo $settings->gallery_text_under_title; ?></div>
                </div>
                <div class="st-height-b40 st-height-lg-b40"></div>
            </div>
            <div class="container">
                    ...
                    <div class="st-isotop st-style1 st-port-col-3 st-has-gutter st-lightgallery">
                        ...
                        <div class="st-isotop-item <?php echo $image->position; ?>">
                            <a href="<?php echo $image->img; ?>" class="st-project st-zoom st-lightbox-item st-link-hover-wrap">
                                <div class="st-project-img st-zoom-in"><img src="<?php echo $image->img; ?>"
                                        alt="project1"></div>
        ...
        <!-- Start Before After -->
        <section class="st-before-after-section st-dynamic-bg st-bg" data-src="themes/assets/img/before-after-bg.jpg">
            <div class="st-height-b120 st-height-lg-b80"></div>
            <div class="container">
                <div class="st-section-heading st-style1">
                ...
                <div class="container">
                    <div class="st-before-after-in">
                        <div class="st-before-after">
                            <div class="st-after st-single-slide st-dynamic-bg" data-src="themes/assets/img/after.jpg">
                            </div>
                            <div class="st-before st-single-slide st-dynamic-bg"
                                data-src="themes/assets/img/before.jpg"></div>
        ...
        <section id="review">
            ...
            <div class="container">
                <div class="st-section-heading st-style1">
                    ...
                    <?php
          $text1 = $settings->block_1_text_under_title;
          $words1 = explode(' ', $text1);
          $first_six_words1 = array_slice($words1, 0, 12);
          $remaining_words1 = array_slice($words1, 12);
          $first_section1 = implode(' ', $first_six_words1);
                            ...
                            <div class="slick-slide-in">
                                <div class="st-testimonial st-style1 wow fadeInLeft" data-wow-duration="0.8s"
                                    ...
                                    <div class="st-testimonial-info">
                                        <div class="st-testimonial-img"><img src="<?php echo $review->img; ?>"
                                                alt="avatar1"></div>
                                        <div class="st-testimonial-meta">
                                            <h4 class="st-testimonial-name"><?php echo $review->name; ?></h4>
                                            <div class="st-testimonial-designation"><?php echo $review->designation; ?>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="st-testimonial-text"><?php echo $review->review; ?></div>
        ...
        <div class="row">
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="st-funfact st-style1">
                  ...
                  <h2 class="st-funfact-number st-counter"><?php echo $settings->years_of_experience; ?></h2>
              ...
              <div class="col-lg-6">
                <div class="st-funfact st-style1">
                  ...
                  <h2 class="st-funfact-number st-counter"><?php echo $settings->happy_patients; ?></h2>
              ...
              <div class="col-lg-6">
                <div class="st-funfact st-style1">
                  ...
                  <h2 class="st-funfact-number st-counter"><?php echo $settings->qualified_doctors; ?></h2>
              ...
              <div class="col-lg-6">
                <div class="st-funfact st-style1">
                  ...
                  <h2 class="st-funfact-number st-counter"><?php echo $settings->hospital_rooms; ?></h2>
          ...
          <div class="col-xl-6 wow fadeInRight" data-wow-duration="0.8s" data-wow-delay="0.2s">
            <div class="st-video-block st-style1 st-zoom">
              <div class="st-video-block-img st-zoom-in st-dynamic-bg" data-src="<?php echo $settings->video_image; ?>"></div>
              <a href="<?php echo $settings->website_video_link; ?>" class="st-play-btn st-style1 st-video-open">
                <svg version="1.1"   xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
      ...
      <div class="st-shape5">
        <img src="themes/assets/img/shape/faq-bg.svg" alt="shape1">
      </div>
      <div class="st-height-b120 st-height-lg-b80"></div>
      <div class="container">
        <div class="row">
      ...
      <div class="st-height-b120 st-height-lg-b80"></div>
                        ...
                        <div class="slick-wrapper">
                            <div class="slick-slide-in">
                                <div class="st-logo-carousel st-style1 st-orange-box">
                                    <img src="themes/assets/img/client1.png" alt="client1">
                                </div>
                            </div><!-- .slick-slide-in -->
                            <div class="slick-slide-in">
                                <div class="st-logo-carousel st-style1 st-blue-box">
                                    <img src="themes/assets/img/client2.png" alt="client2">
                                </div>
                            </div><!-- .slick-slide-in -->
                            <div class="slick-slide-in">
                                <div class="st-logo-carousel st-style1 st-red-box">
                                    <img src="themes/assets/img/client3.png" alt="client3">
                                </div>
                            </div><!-- .slick-slide-in -->
                            <div class="slick-slide-in">
                                <div class="st-logo-carousel st-style1 st-green-box">
                                    <img src="themes/assets/img/client4.png" alt="client4">
                                </div>
                            </div><!-- .slick-slide-in -->
                            <div class="slick-slide-in">
                                <div class="st-logo-carousel st-style1 st-dip-blue-box">
                                    <img src="themes/assets/img/client5.png" alt="client5">
                                </div>
                            </div><!-- .slick-slide-in -->
                            <div class="slick-slide-in">
                                <div class="st-logo-carousel st-style1 st-orange-box">
        ...
        <div class="st-google-map">
            <iframe src="<?php echo $settings->coordinates; ?>"
                allowfullscreen></iframe>
        </div>
    </div>
    <!-- Start Footer -->
    <footer class="st-site-footer st-sticky-footer st-dynamic-bg" data-src="themes/assets/img/footer-bg.png">
                    ...
                    <div class="col-lg-3">
                        <div class="st-footer-widget">
                            <div class="st-text-field">
                                <img src="<?php echo $settings->logo; ?>" alt="Nischinto" class="st-footer-logo">
                                <div class="st-height-b25 st-height-lg-b25"></div>
                                <div class="st-footer-text"><?php echo $settings->description; ?></div>
                                <div class="st-height-b25 st-height-lg-b25"></div>
                                <ul class="st-social-btn st-style1 st-mp0">
                                    <li><a href="<?php echo $settings->facebook_id; ?>"><i
                                                class="fab fa-facebook-square"></i></a></li>
                                    <li><a href="<?php echo $settings->google_id; ?>"><i
                                                class="fab fa-linkedin"></i></a></li>
                                    <li><a href="<?php echo $settings->youtube_id; ?>"><i
                                                class="fab fa-pinterest-square"></i></a></li>
                                    <li><a href="<?php echo $settings->twitter_id; ?>"><i
                                                class="fab fa-twitter-square"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3">
                        <div class="st-footer-widget">
                            ...
                            <ul class="st-footer-widget-nav st-mp0">
                                <li><a href="site/<?php echo $this->session->userdata('site_name'); ?>#home"><i
                                            class="fas fa-chevron-right"></i>Home</a></li>
                                <li><a href="site/<?php echo $this->session->userdata('site_name'); ?>#about"><i
                                            class="fas fa-chevron-right"></i>About</a></li>
                                <li><a href="site/<?php echo $this->session->userdata('site_name'); ?>#department"><i
                                            class="fas fa-chevron-right"></i>Department</a></li>
                                <li><a href="site/<?php echo $this->session->userdata('site_name'); ?>#doctors"><i
                                            class="fas fa-chevron-right"></i>Doctors</a></li>
                                <li><a href="site/<?php echo $this->session->userdata('site_name'); ?>#gallery"><i
                                            class="fas fa-chevron-right"></i>Gallery</a></li>
                                <li><a href="site/<?php echo $this->session->userdata('site_name'); ?>#review"><i
                                            class="fas fa-chevron-right"></i>Review</a></li>
                            </ul>
                        </div>
                    </div><!-- .col -->
                    <div class="col-lg-3">
                        <div class="st-footer-widget">
                            ...
                            <ul class="st-footer-widget-nav st-mp0">
                                <li><a href="site/<?php echo $this->session->userdata('site_name'); ?>#"><i
                        ...
                        <div class="st-footer-widget">
                            ...
                            <ul class="st-footer-contact-list st-mp0">
                                <li><span class="st-footer-contact-title">Address:</span>
                                    <?php echo $settings->address; ?></li>
                                <li><span class="st-footer-contact-title">Email:</span> <?php echo $settings->email; ?>
                                </li>
                                <li><span class="st-footer-contact-title">Phone:</span> <?php echo $settings->phone; ?>
                                </li>
                            </ul>
                        </div>
                    </div><!-- .col -->
            ...
            <div class="container">
                <div class="st-copyright-in">
                    <div class="st-left-copyright">
                        <div class="st-copyright-text">Copyright <?php echo date('Y'); ?> &copy;.
                            <?php echo $settings->footer_text; ?></div>
                    </div>
    ...
    <!-- Scripts -->
    <script src="themes/assets/js/vendor/modernizr-3.5.0.min.js"></script>
    <script src="themes/assets/js/vendor/jquery-1.12.4.min.js"></script>
    <script src="themes/assets/js/isotope.pkg.min.js"></script>
    <script src="themes/assets/js/jquery.slick.min.js"></script>
    <script src="themes/assets/js/mailchimp.min.js"></script>
    <script src="themes/assets/js/counter.min.js"></script>
    <script src="themes/assets/js/lightgallery.min.js"></script>
    <script src="themes/assets/js/ripples.min.js"></script>
    <script src="themes/assets/js/wow.min.js"></script>
    <script src="themes/assets/js/jQueryUi.js"></script>
    <script src="themes/assets/js/textRotate.min.js"></script>
    <script src="themes/assets/js/select2.min.js"></script>
