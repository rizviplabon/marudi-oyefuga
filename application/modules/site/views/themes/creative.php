...
<head>
  ...
  <link rel="stylesheet" href="themes/assets/css/theme/theme_type2.css" />
</head>
...
<body>
        ...
        <div class="st-top-header-in">
          <ul class="st-top-header-list">
            <li>
              ...
              <a href="site/<?php echo $this->session->userdata('site_name'); ?>#"><?php echo $settings->email; ?></a>
            </li>
            <li>
              ...
              <a href="site/<?php echo $this->session->userdata('site_name'); ?>#"><?php echo $settings->phone; ?></a>
            </li>
          </ul>
          ...
          <div class="st-main-header-right">
            <div class="st-nav">
              <ul class="st-nav-list st-onepage-nav">
                ...
                <li><a href="site/<?php echo $this->session->userdata('site_name'); ?>#service"
                    class="st-smooth-move">Service</a></li>
                ...
                <li><a href="site/<?php echo $this->session->userdata('site_name'); ?>#reviews"
                    class="st-smooth-move">Reviews</a></li>

                <!-- <li class="menu-item-has-children"><a href="#blog" class="st-smooth-move">Blog</a> -->
                <!-- <ul>
                    <li><a href="blog-right-sidebar2.html">Blog List</a></li>
                    <li><a href="blog-details-right-sidebar2.html">Blog Details</a></li>
                  </ul> -->
                <!-- </li> -->
  ...
  <div class="st-content" id="home">
        ...
        <div class="container">
          <div class="st-hero-in">
            <div class="st-hero-text">
              <h3 class="st-hero-mini-title st-pink"><?php echo $slide->text1; ?> </h3>
              <h1 class="st-hero-title"><?php echo $slide->text2; ?> </h1>
              <div class="st-hero-subtitle"><?php echo $slide->text3; ?> </div>
              <div class="st-hero-btn-group">
                <a href="#service" class="st-btn st-style1 st-color4 st-smooth-move">Our Services</a>
              </div>
            </div>
            <div class="st-hero-img">
              <img src="<?php echo $slide->img_url; ?>" alt="Hero Image">
              <a href="<?php echo $settings->website_video_link; ?>"
                class="st-play-btn st-style1 st-color1 st-video-open">
          ...
          <div class="col-xl-6">
            <div class="st-left-full-width">
              <div class="text-center">
                <img src="<?php echo $settings->appointment_img_url; ?>" alt="">
              </div>
            </div>
          </div><!-- .col -->
          <div class="col-xl-6">
            <div class="st-vertical-middle">
              <div class="st-vertical-middle-in">
                ...
                <?php $text3 = $settings->appointment_title;
          $words = explode(' ', $text3);
          if (count($words) >= 3) {
            $words[3] = '<span class="st-pink">' . $words[3] . '</span>';
        }
        
        $styled_text = implode(' ', $words);?>
                  <h2 class="st-text-block-title"><?php echo $styled_text; ?> </h2>  
                  ...
                  <div class="st-text-block-text">
                    ...
                    <a href="#appointment"
                      class="st-btn st-style1 st-color4  st-size-medium st-smooth-move">Make an
                      Appointment</a>
                  </div>
                </div>
              </div>
    ...
    <section id="service">
      ...
      <div class="container">
        <div class="st-section-heading st-style2">
          <?php
          $text = $settings->service_block__text_under_title;
          $words = explode(' ', $text);
          $first_six_words = array_slice($words, 0, 6);
          $remaining_words = array_slice($words, 6);
          $first_section = implode(' ', $first_six_words);
          $second_section = implode(' ', $remaining_words);
          $text3 = $second_section;
          $words = explode(' ', $text3);
          if (count($words) >= 3) {
            $words[2] = '<span class="st-pink">' . $words[2] . '</span>';
        }
        
        $styled_text = implode(' ', $words);
          ?>
          <h2 class="st-section-heading-title"><?php echo $first_section; ?> <br>
            <?php echo $styled_text; ?> </h2>
        </div>
        <div class="st-height-b35 st-height-lg-b35"></div>
      </div>
      <div class="container">
        <div class="st-slider st-style3">
            ...
            <div class="slick-wrapper">
              <?php foreach ($services as $service) { ?>
                <div class="slick-slide-in">
                  <div class="st-imagebox st-style3 st-type1 st-zoom text-center">
                    <div class="st-imagebox-img"><img src="<?php echo $service->img_url; ?>"
                        alt="Service Image..." class="st-zoom-in"></div>
                    <div class="st-imagebox-info">
                      <h2 class="st-imagebox-title"><?php echo $service->title; ?></h2>
                      <div class="st-imagebox-subtitle"><?php echo $service->description; ?></div>
                    </div>
                  </div>
                </div><!-- .slick-slide-in -->
              <?php } ?>
          ...
          <div class="swipe-arrow st-style3">
    ...
    <section class="st-before-after-section st-dynamic-bg st-bg" data-src="themes/assets/img/before-after-bg.jpg">
      ...
      <div class="container">
        <div class="st-section-heading st-style2">
          <h2 class="st-section-heading-title">Some samples of our work <br> <span
              class="st-pink">before</span> and <span class="st-pink">after</span></h2>
        </div>
        <div class="st-height-b35 st-height-lg-b35"></div>
      </div>
          ...
          <div class="st-before-after-in">
            <div class="st-before-after">
              <div class="st-after st-single-slide st-dynamic-bg"
                data-src="themes/assets/img/dental/before.jpg"></div>
              <div class="st-before st-single-slide st-dynamic-bg"
                data-src="themes/assets/img/dental/after.jpg"></div>
    ...
    <!-- <section id="price">
      ...
      <div class="container">
        <div class="st-section-heading st-style2">
          <h2 class="st-section-heading-title">What is the <span class="st-pink">cost</span> your <br>dental
            treatment</h2>
        </div>
        <div class="st-height-b35 st-height-lg-b35"></div>
      </div>
            ...
            <div class="st-tabs st-fade-tabs st-style1">
              <ul class="st-tab-links st-style2 st-type1 st-color2 st-mp0">
                <li class="st-tab-title active ">
                  <a href="#plan_a">Plan A</a>
                </li>
                <li class="st-tab-title">
                  <a href="#plan_b">Plan B</a>
                </li>
                <li class="st-tab-title">
                  <a href="#plan_c">Plan C</a>
                </li>
              </ul>
              <div class="st-height-b30 st-height-lg-b30"></div>
              <div class="tab-content">
                <div id="plan_a" class="st-tab active">
                  <div class="st-pricing-table st-style2 st-type1 st-color2">
                    <div class="st-pricing-left">
                      <div class="st-pricing-img st-dynamic-bg st-bg"
                        data-src="themes/assets/img/dental/plana.jpg"></div>
                    </div>
                    <div class="st-pricing-right">
                      <div class="st-pricing-title">Plan A is for under 15 year olds</div>
                      ...
                      <ul class="st-pricing-list">
                        ...
                        <li>
                          <span>Straighten teeth</span>
                          <span>$350</span>
                        </li>
                        <li>
                          <span>Porcelain bridge</span>
                          <span>$650</span>
                        </li>
                        <li>
                          <span>Simple extraction</span>
                          <span>$180</span>
                        </li>
                      </ul>
                    </div>
                ...
                <div id="plan_b" class="st-tab">
                  <div class="st-pricing-table st-style2 st-type1 st-color2">
                    <div class="st-pricing-left">
                      <div class="st-pricing-img st-dynamic-bg st-bg"
                        data-src="themes/assets/img/dental/plana2.jpg"></div>
                    </div>
                    <div class="st-pricing-right">
                      <div class="st-pricing-title">Plan B is for above 16 year olds</div>
                      <div class="st-pricing-list-head">
                        <span>Treatment</span>
                        <span>Price</span>
                      </div>
                ...
                <div id="plan_c" class="st-tab">
                  <div class="st-pricing-table st-style2 st-type1 st-color2">
                    <div class="st-pricing-left">
                      <div class="st-pricing-img st-dynamic-bg st-bg"
                        data-src="themes/assets/img/dental/plana3.jpg"></div>
                    </div>
                    <div class="st-pricing-right">
                      <div class="st-pricing-title">Plan C is for above 40 year olds</div>
                      <div class="st-pricing-list-head">
                        <span>Treatment</span>
                        <span>Price</span>
                      </div>
            ...
            <div class="st-vertical-middle">
              ...
              <form action="site/addNew" method="post" id="addAppointmentForm">
                  ...
                  <div class="st-section-heading st-style2 text-left">
                    <h2 class="st-section-heading-title">Make <span
                        class="st-pink">appointment</span> We always welcome new patients</h2>
                  </div>
                  <div class="st-height-b35 st-height-lg-b35"></div>
                  ...
                  <div class="pos_client">
                    <div class="st-form-field st-style1 st-color2">
                      <input type="text" id="uname" name="p_name" placeholder="Full Name"
                        >
                    </div>
                    <div class="st-form-field st-style1 st-color2">
                      <input type="text" id="uemail" name="p_email" placeholder="Email address"
                        >
                    </div>
                    <div class="st-form-field st-style1 st-color2">
                      <input type="text" id="unumber" name="p_phone" placeholder="Phone number"
                        >
                    </div>
                    <div class="st-form-field st-style1 st-color2">
                  ...
                  <div class="st-form-field st-style1 st-color2">
                    <input name="date" class="default-date-picker" type="text" id="date" placeholder="dd/mm/yy">
                    <div class="form-field-icon"><i class="fa fa-calendar"></i></div>
                  </div>
                  <div class="st-form-field st-style1 st-color2">
                    <div class="st-custom-select-wrap">
                      <select name="time_slot" class="st_select1" id="aslots" data-placeholder="Select Slot">
                      </select>
                    </div>
                  </div>
                  <div class="st-form-field st-style1 st-color2">
                    <div class="st-custom-select-wrap">
                      <select name="visit_description" class="st_select1" id="visit_description" data-placeholder="Select Visit Type">
                      </select>
                    </div>
                  </div>
                  <div class="st-form-field st-style1 st-color2">
                    <textarea cols="30" rows="10" id="umsg" name="remarks"
                      placeholder="Write something here..."></textarea>
                  </div>
                  <div class="st-form-field st-style1 st-color2">
                    <input type="text" id="visit_charges" name="visit_charges" placeholder="Visit Charges"
                      >
                  </div>
                  ...
                  <!-- <div class="st-style1 st-color2">
                    <input type="checkbox" id="pay_now_appointment" name="pay_now_appointment" value="pay_now_appointment">
                    <label for="pay_now_appointment"><?php echo lang('pay_now'); ?></label><br>
                  </div> -->
                  <?php $payment_gateway = $settings1->payment_gateway; ?>
                  <div class="card1">
                    <hr>
                    <?php if ($payment_gateway == 'PayPal') { ?>
                      <div class="st-form-field st-style1 st-color2">
                        <div class="st-custom-select-wrap">
                          <select name="card_type" class="st_select1" data-placeholder="Select Card Type">
                    ...
                    <?php if ($payment_gateway != 'Pay U Money' && $payment_gateway != 'Paystack' && $payment_gateway != 'SSLCOMMERZ' && $payment_gateway != 'Paytm') { ?>
                      <div class="st-form-field st-style1 st-color2">
                        <input type="text" id="card" name="card_number" placeholder="Card Number">
                      </div>
                      <div class="st-form-field st-style1 st-color2">
                        <input type="text" id="expire" name="expire_date" placeholder="Expiry (MM/YY)">
                      </div>
                      <div class="st-form-field st-style1 st-color2">
                        <input type="text" id="cvv" name="cvv" placeholder="Cardholder Name">
                      </div>
                    <?php } ?>
                  </div>
                  <?php $twocheckout = $this->db->get_where('paymentGateway', array('name =' => '2Checkout'))->row(); ?>
                                                <button type="submit" name="pay_now" id="submit-btn" class="st-btn st-style1 st-color4 st-size-medium" <?php if ($settings1->payment_gateway == 'Stripe') {
          ...
          <div class="col-xl-6">
            <div class="st-right-full-width">
              <div class="st-infobox-wrap text-center">
                <img src="themes/assets/img/dental/appointment2.png" alt="Appointment">
                <div class="st-infobox st-style1 st-type1 st-color2">
                  <div class="st-infobox-text">Monday - Friday: 8:00am - 8:00pm <br>Saturday: 8:00am -
                    6:00pm <br>Sunday: closed</div>
    ...
    <section id="reviews">
      ...
      <div class="container">
        <div class="st-section-heading st-style2">
          ...
          $first_six_words1 = array_slice($words1, 0, 6);
          $remaining_words1 = array_slice($words1, 6);
          $first_section1 = implode(' ', $first_six_words1);
          $second_section1 = implode(' ', $remaining_words1);
          $text3 = $first_section1;
          $words = explode(' ', $text3);
          if (count($words) >= 5) {
            $words[5] = '<span class="st-pink">' . $words[5] . '</span>';
        }
        
        $styled_text = implode(' ', $words);
          ?>
          <h2 class="st-section-heading-title"><?php echo $styled_text; ?> <br>
            <?php echo $second_section1; ?> <span class="st-pink"></span> <br></h2>
        </div>
        <div class="st-height-b35 st-height-lg-b35"></div>
      </div>
      <div class="container">
          ...
          <div class="slick-container" data-autoplay="0" data-loop="1" data-speed="600" data-center="0"
            ...
            <div class="slick-wrapper">
              <?php foreach ($reviews as $review) { ?>
                <div class="slick-slide-in">
                  <div class="st-testimonial st-style1 st-type1 st-color1 wow fadeInLeft"
    ...
    <section id="doctors" class="st-gray-bg2">
      ...
      <div class="container">
        <?php
        $text1 = $settings->doctor_block__text_under_title;
        $words1 = explode(' ', $text1);
        $first_six_words1 = array_slice($words1, 0, 4);
        $remaining_words1 = array_slice($words1, 4);
        $first_section1 = implode(' ', $first_six_words1);
        $second_section1 = implode(' ', $remaining_words1);
        $text3 = $second_section1;
          $words = explode(' ', $text3);
          if (count($words) >= 1) {
            $words[0] = '<span class="st-pink">' . $words[0] . '</span>';
        }
        ...
        <div class="st-section-heading st-style2">
          <h2 class="st-section-heading-title">
            <?php echo $first_section1; ?><br><?php echo $styled_text; ?></h2>
        </div>
        <div class="st-height-b35 st-height-lg-b35"></div>
      </div>
      <div class="container">
                ...
                <div class="slick-slide-in">
                  <div class="st-member st-style1 st-zoom st-color2">
                    <div class="st-member-img">
                      ...
                      <a class="st-doctor-link" href="doctor-profile2.html"><i
                          class="fas fa-link"></i></a>
                    </div>
                    <div class="st-member-meta">
                      <div class="st-member-meta-in">
                        <h3 class="st-member-name"><a
                            href="doctor-profile2.html"><?php echo $featured->name; ?></a></h3>
    ...
    <div class="st-google-map">
      <iframe src="<?php echo $settings->coordinates; ?>" allowfullscreen></iframe>
    </div>
    ...
    <!-- <section class="" id="contact">
      ...
      <div class="container">
        <div class="st-section-heading st-style2">
          <h2 class="st-section-heading-title">Contact us for any <span class="st-pink">dental</span> <br>
            treatment</h2>
        </div>
        <div class="st-height-b35 st-height-lg-b35"></div>
      </div>
      <div class="container">
        <div class="row">
          <div class="col-lg-8 offset-lg-2">
            <div id="st-alert"></div>
            <form action="" class="row st-contact-form st-type2" method="post" id="contact-form">
              ...
              <div class="col-lg-6 offset-lg-3">
                <div class="text-center">
                  ...
                  <button class="st-btn st-style1 st-color4 st-size-medium w-100" type="submit"
          ...
          <div class="col-lg-3">
            <div class="st-footer-widget">
              ...
              <ul class="st-footer-widget-nav st-mp0">
                ...
                <li><a href="site/<?php echo $this->session->userdata('site_name'); ?>#service"><i
                      class="fas fa-chevron-right"></i>Service</a></li>
                <li><a href="site/<?php echo $this->session->userdata('site_name'); ?>#doctors"><i
                      class="fas fa-chevron-right"></i>Doctors</a></li>
                <li><a href="site/<?php echo $this->session->userdata('site_name'); ?>#reviews"><i
                      class="fas fa-chevron-right"></i>Reviews</a></li>
              </ul>
            </div>
          </div><!-- .col -->
          <div class="col-lg-3">
            <div class="st-footer-widget">
              ...
              <ul class="st-footer-widget-nav st-mp0">
                ...
                <!-- <li><a href="site/<?php echo $this->session->userdata('site_name'); ?>#"><i class="fas fa-chevron-right"></i>Face Lift Surgery</a></li> -->
      ...
      <div class="container">
        <div class="st-copyright-in">
          <div class="st-left-copyright">
            <div class="st-copyright-text">Copyright <?php echo date('Y'); ?> &copy;. <?php echo $settings->footer_text; ?></div>
          </div>
