...
<body>
        ...
        <div class="st-main-header-in">
          ...
          <div class="st-main-header-right">
            ...
            <ul class="st-nav-list st-onepage-nav">
              ...
              <a href="#appointment" class="st-btn st-style2 st-size-medium st-color1 st-smooth-move">Appointment Now!</a>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="st-content">
    ...
    <!-- Start Hero Seciton -->
    <div class="st-hero-wrap st-color1 st-bg st-dynamic-bg overflow-hidden st-fixed-bg" data-src="themes/assets/img/hero-bg14.jpg" id="home">
      <div class="st-wave-animation st-left-top st-white"></div>
      <div class="st-hero st-style1 st-type1">
        ...
        <?php
          ...
          ?>
          <div class="st-hero-text st-style3 st-white">
            <h1 class="st-hero-title"><?php echo $first_section; ?> <br> <?php echo $second_section; ?></h1>
            <div class="st-hero-subtitle"><?php echo $first_section1; ?> <br> <?php echo $second_section1; ?></div>
            <div class="st-hero-btn">
              <a href="#appointment" class="st-btn st-style2 st-color2 st-smooth-move">Appointment</a>
            </div>
          </div>
          <div class="st-shedule-wrap">
            <div class="st-shedule">
              <h2 class="st-shedule-title">Office Hours</h2>
        ...
        <div class="row">
          ...
          <div class="col-lg-6 wow fadeInRight" data-wow-duration="0.8s" data-wow-delay="0.2s">
            <div class="st-about-img">
              <div class="st-about-img-in st-dynamic-bg st-bg" data-src="themes/assets/img/hero-bg3.jpg">
    ...
    <section id="department">
      ...
      <div class="container">
        <div class="st-section-heading st-style1">
          ...
          <div class="st-section-heading-subtitle">Welcome to our Department. Our dedicated team of professionals is committed to <br> providing
