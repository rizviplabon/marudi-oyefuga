...
class Meeting extends MX_Controller {
    ...
    function live() {
        ...
        if ($meeting_id == $live_details->meeting_id) {
            $this->load->view('meeting/live', $data);
        } else {
    ...
    function jitsiLive() {
        ...
        $this->load->view('meeting/jitsi', $data);
        $this->load->view('home/footer'); // just the header file
    }
...
//API Requests Starts
    ...
    //         $this->load->view('home/dashboard'); // just the header file
    //         $this->load->view('meeting/settings', $data);
...
// API Requests Ends
    ...
    public function request() {
        ...
        $data['settings'] = $this->settings_model->getSettings();
        $this->load->view('home/dashboard', $data); // just the header file
        $this->load->view('meeting/meeting_request', $data);
        $this->load->view('home/footer'); // just the header file
    }
    ...
    public function todays() {
        ...
        $data['settings'] = $this->settings_model->getSettings();
        $this->load->view('home/dashboard', $data); // just the header file
        $this->load->view('meeting/todays', $data);
        $this->load->view('home/footer'); // just the header file
    }
    ...
    public function upcoming() {
        ...
        $data['settings'] = $this->settings_model->getSettings();
        $this->load->view('home/dashboard', $data); // just the header file
        $this->load->view('meeting/upcoming', $data);
        $this->load->view('home/footer'); // just the header file
    }
    ...
    public function previous() {
        ...
        $data['settings'] = $this->settings_model->getSettings();
        $this->load->view('home/dashboard', $data); // just the header file
        $this->load->view('meeting/previous', $data);
        $this->load->view('home/footer'); // just the header file
    }
    ...
    function calendar() {
        ...
        $data['settings'] = $this->settings_model->getSettings();
        $this->load->view('home/dashboard', $data); // just the header file
        $this->load->view('meeting/calendar', $data);
        $this->load->view('home/footer'); // just the header file
    }
    ...
    public function addNewView() {
        ...
        $data['settings'] = $this->settings_model->getSettings();
        $this->load->view('home/dashboard', $data); // just the header file
        $this->load->view('meeting/add_new', $data);
        $this->load->view('home/footer'); // just the header file
    }
    ...
    function getMeetingByDoctorId() {
        ...
        $data['settings'] = $this->settings_model->getSettings();
        $this->load->view('home/dashboard', $data); // just the header file
        $this->load->view('meeting/meeting_by_doctor', $data);
        $this->load->view('home/footer'); // just the header file
    }
    ...
    function myMeetings() {
        ...
        $this->load->view('home/dashboard', $data); // just the header file
        $this->load->view('meeting/mymeetings', $data);
        $this->load->view('home/footer'); // just the header file
    }
    ...
    function zoomSettings() {
        $data = array();
        $id = $this->input->get('id');
        $data['doctor_details'] = $this->doctor_model->getDoctorById($id);
        // print_r($data['doctor_details']);die();
        $data['settings'] = $this->meeting_model->getMeetingSettingsById($data['doctor_details']->ion_user_id);
    ...
    function settings()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            $data['settings'] = $this->meeting_model->getMeetingSettingsById($ion_user_id);
            $this->load->view('home/dashboard'); // just the header file
            $this->load->view('meeting/settings', $data);
            $this->load->view('home/footer'); // just the footer file
        } else {
           ...
           redirect('meeting/zoomSettings?id=' . $doctor);
        }
    }
...
public function zoomLive() {
    ...
    try {
        ...
        if (isset($meeting['id'])) {
            ...
            $this->session->set_flashdata('feedback', 'Failed to create meeting');
            redirect('appointment');
        }
    } catch (Exception $e) {
        $this->session->set_flashdata('feedback', 'Failed to create meeting');
