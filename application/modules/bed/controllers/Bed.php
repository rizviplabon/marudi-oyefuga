...
class Bed extends MX_Controller
{
        ...
        foreach ($data['beds'] as $bed) {
            ...
            if($this->ion_auth->in_group('admin')){
                if($this->settings->dashboard_theme =='main'){
                   ...
                   $all_options.= '
                      <a class="dropdown-item editbutton" data-toggle="modal" data-id="'. $bed->id. '">'. lang('edit'). '</a>
                      <a class="dropdown-item" href="bed/delete?id='. $bed->id. '" onclick="return confirm(\'Are you sure you want to delete this item?\');">'. lang('delete'). '</a>';
        ...
        foreach ($data['beds'] as $bed) {
            ...
            if($this->ion_auth->in_group('admin')){
                if($this->settings->dashboard_theme =='main'){
                   ...
                   $all_options.= '<a class="dropdown-item editbutton" href="bed/bedAllotmentDetails?id=' . $bed->id . '">'. lang('all') .' '. lang('details') .'</a>
                   <a class="dropdown-item editbutton" target="_blank" href="bed/billDetails?id=' . $bed->id . '">'. lang('bill') . ' ' . lang('details') . '</a>
                      <a class="dropdown-item editbutton" target="_blank" href="bed/printLabel?id=' . $bed->id . '">Label Print</a>
                      <a class="dropdown-item" href="bed/deleteAllotment?id=' . $bed->id . '" onclick="return confirm(\'Are you sure you want to delete this item?\');">'. lang('delete'). '</a>';
                      if (!empty($bed->d_time)) {
                        $all_options .= '<a class="dropdown-item" href="bed/dischargeReport?id=' . $bed->id . '"> ' . lang('discharge_report') . '</a>';
                    } else {
                        $all_options .= ' ';
                    }
               $all_options.= '</div>
                ...
                $all_options = $option1 . ' ' . $bill_summary_button . ' ' . $option3 . ' ' . $decharge . ' ' . $option2;
            }}else{
                $all_options = $option1 . ' ' . $bill_summary_button . ' ' . $option3 . ' ' . $decharge . ' ' . $option2;
            }
    ...
    public function getAvaiablePatietListforBedAllotment()
    {
        ...
        // Get users
        $response = $this->patient_model->getAvaiablePatietListforBedAllotment($searchTerm);
    ...
    function ReaTimeBedAvailabilityTracking()
    {      
     if($this->ion_auth->in_group('admin')){                
        if($this->settings->dashboard_theme == 'main'){
            $this->load->view('home/layout/header'); 
    ...
    function AutomatedPatientAssignment()
    {
        // $this->load->view('home/dashboard');
        $this->load->view('patient/comming_soon');
        // $this->load->view('home/footer');
    ...
    function IntegrationwithHospitalSystems()
    {
        // $this->load->view('home/dashboard');
        $this->load->view('patient/comming_soon');
        // $this->load->view('home/footer');
    ...
    function DischargePlanningTools()
    {
        // $this->load->view('home/dashboard');
        $this->load->view('patient/comming_soon');
        // $this->load->view('home/footer');
    ...
    function EmergencyBedAllocation()
    {
        // $this->load->view('home/dashboard');
        $this->load->view('patient/comming_soon');
        // $this->load->view('home/footer');
    ...
    function CentralizedCommunicationPlatform()
    {
        // $this->load->view('home/dashboard');
        $this->load->view('patient/comming_soon');
        // $this->load->view('home/footer');
    ...
    function CustomizableDashboards()
    {
        // $this->load->view('home/dashboard');
        $this->load->view('patient/comming_soon');
        // $this->load->view('home/footer');
