            ...
            if ($case->added_by == $current_user_id) {
                ...
                if($this->ion_auth->in_group('admin')){
                    if($this->settings->dashboard_theme =='main'){
                       ...
                       $all_options.= '
                          <a class="dropdown-item editbutton1" data-toggle="modal" data-id="'. $case->id. '">'. lang('edit'). '</a>
                          <a class="dropdown-item" href="email/deleteManualEmailTemplate?id=' . $case->id . '&redirect=sms/smsTemplate" onclick="return confirm(\'Are you sure you want to delete this item?\');">'. lang('delete'). '</a>';
