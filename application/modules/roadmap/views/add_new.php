...
<style>
    ...
    <div class="col-12">
        <div class="card mb-4">
            <div class="card-header"><strong>Roadmap</strong></div>
            <div class="card-body">
                <form action="roadmap/addNew" method="post" accept-charset="utf-8">
                    ...
                    <div class="tab-content rounded-bottom">
                        <div class="tab-pane p-3 active preview" role="tabpanel" id="preview-237"
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control " type="text" name="title" placeholder="Roadmap Title" value="<?php
                                if (!empty($setval)) {
