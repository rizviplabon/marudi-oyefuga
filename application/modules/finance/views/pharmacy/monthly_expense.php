...
<div class="page-content">
 ...
 <div class="card-header table_header">
                                        <h4 class="card-title mb-0 col-lg-8"> <?php echo date('Y', $first_minute) . ' ' .lang('pharmacy').' '. lang('expense_report'); ?>  </h4> 
                                        <div class="col-lg-4 no-print row"> 
                                            <div class="col-md-4 pull-right">
                                        <a class="btn btn-primary " onclick="javascript:window.print();"> <i class="fa fa-print"></i>  </a></div>
                                        <div class="col-md-4 pull-right">
                                         <a class="btn btn-soft-info" href="finance/pharmacy/monthlyExpense?year=<?php echo $previous_year; ?>">
                                             <i class="fa fa-arrow-left"></i> Prev
                                        </a>
                                        </div>
                                        <div class="col-md-4 pull-right">
                                        <a class="btn btn-soft-info" href="finance/pharmacy/monthlyExpense?year=<?php echo $next_year; ?>">
