...
<div class="page-content">
                ...
                <?php }
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active"><?php echo lang('monthly'); ?></li>
                                    </ol>
                                </div>
 ...
 <div class="card-header table_header">
                                        <h4 class="card-title mb-0 col-lg-8"> <?php echo date('Y', $first_minute) . ' ' .lang('pharmacy').' '. lang('sales_report'); ?>  </h4> 
                                        <div class="col-lg-4 no-print row"> 
                                            <div class="col-md-4 pull-right">
                                        <a class="btn btn-primary " onclick="javascript:window.print();"> <i class="fa fa-print"></i>  </a></div>
                                        <div class="col-md-4 pull-right">
                                         <a class="btn btn-soft-info" href="finance/pharmacy/monthly?year=<?php echo $next_year; ?>">
                                             <i class="fa fa-arrow-left"></i> Prev
                                        </a>
                                        </div>
                                        <div class="col-md-4 pull-right">
                                        <a class="btn btn-soft-info" href="finance/pharmacy/monthly?year=<?php echo $previous_year; ?>">
