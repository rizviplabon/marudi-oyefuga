                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="invoice">
                                        ...
                                        ?>
                                        <h4 class="inv-header-1"><?php echo lang('invoice'); ?>: #<?php echo $invoice_id; ?></h4>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="invoice-name text-end">
                                        ...
                                        <p><?php echo $settings->title; ?>, <?php echo $settings->address; ?></p>
                                        <p class="mb-0"><?php echo lang('phone'); ?>: <?php echo $settings->phone; ?></p>
                                    </div>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="informeshon">
                                        <p class="inv-title-1"><?php echo lang('date'); ?></p>
                                ...
                                <div class="col-sm-4">
                                    <div class="informeshon">
                                        <p class="inv-title-1"><?php echo lang('invoice'); ?> <?php echo lang('to'); ?>.</p>
                                        <?php 
                                ...
                                <div class="col-sm-4">
                                    <div class="informeshon text-end">
                                        <p class="inv-title-1"><?php echo lang('bill'); ?> <?php echo lang('from'); ?>.</p>
                                        <p class="invo-addr-1">
