    ...
    function getPaymentList() {
        ...
        foreach ($data['payments'] as $payment) {
            ...
            if ($this->ion_auth->in_group(array('admin', 'Pharmacist'))) {
                $option1 = '<a class="btn btn-soft-info btn-xs editbutton" href="finance/pharmacy/editPayment?id=' . $payment->id . '"><i class="fa fa-edit"> </i> ' . lang('edit') . '</a>';
            }
            if ($this->ion_auth->in_group('admin')) {
                $option2 = '<a class="btn btn-soft-danger btn-xs btn_width delete_button" href="finance/pharmacy/delete?id=' . $payment->id . '" onclick="return confirm(\'Are you sure you want to delete this item?\');"><i class="fa fa-trash"> </i></a>';
            }
            $option3 = '<a class="btn btn-soft-primary btn-xs"  href="finance/pharmacy/invoice?id=' . $payment->id . '"><i class="fa fa-file-invoice"></i> ' . lang('invoice') . '</a>';
            $options4 = '<a class="btn btn-soft-warning btn-xs" title="' . lang('print') . '"  href="finance/pharmacy/printInvoice?id=' . $payment->id . '"target="_blank"> <i class="fa fa-print"></i> ' . lang('print') . '</a>';
            ...
            if($this->ion_auth->in_group('admin')){
                if($this->settings->dashboard_theme =='main'){
                   ...
                   $all_options.= '<a class="dropdown-item editbutton" href="finance/pharmacy/editPayment?id=' . $payment->id . '">'. lang('edit'). '</a>
                   <a class="dropdown-item editbutton" href="finance/pharmacy/invoice?id=' . $payment->id . '">'. lang('invoice'). '</a>
                      <a class="dropdown-item editbutton" href="finance/pharmacy/printInvoice?id=' . $payment->id . '"target="_blank">'. lang('print'). '</a>
                      <a class="dropdown-item" href="finance/pharmacy/delete?id=' . $payment->id . '" onclick="return confirm(\'Are you sure you want to delete this item?\');">'. lang('delete'). '</a>';
