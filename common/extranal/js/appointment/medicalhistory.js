      ...
      $.ajax({
        ...
        success: function (response1) {
          if (response1 && response1.response) {
            ...
            $("#visit_description").html("<option value=''>No visit description found</option>").end();
          }
        },
        error: function(xhr, status, error) {
          console.error("Error fetching doctor visit: " + error);
          console.log(xhr.responseText);
          $("#visit_description").html("<option value=''>Error loading visit description</option>").end();
        }
      });
    }
  });
      ...
      $.ajax({
        ...
        success: function (response1) {
          if (response1 && response1.response) {
            ...
            $("#visit_description1").html("<option value=''>No visit description found</option>").end();
          }
        },
        error: function(xhr, status, error) {
          console.error("Error fetching doctor visit: " + error);
          console.log(xhr.responseText);
          $("#visit_description1").html("<option value=''>Error loading visit description</option>").end();
        }
      });
    }
  });
