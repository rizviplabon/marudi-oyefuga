      ...
      success: function (response) {
        ...
        if (data.added.redir === "added") {
          ...
          row_data +=
            ...
            "</td><td>" +
            data.nurse.name +
            "</td><td class='no-print'> <button type='button' class='btn btn-soft-info btn-xs btn_width editbutton_dailyprogress' title='" +
            edit +
            "' data-toggle='' data-id=" +
            data.info.id +
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        row_data +=
          ...
          data.info.id +
          "'> <button type='button' class='btn btn-soft-danger btn-xs btn_width delete_medicine' title='" +
          delete_lang +
          "' data-toggle='' data-id=" +
          data.info.id +
...
$(document).ready(function () {
  ...
  $(".pservice_div").on("change", "#pservice", function () {
    ...
    var id = $(this).val();
    // $("#service_options select> option:selected").each(function () {
    //   $('div#Iservice_options select> option:selected').each(function () {
    //   arr.push($(this).val());
    // });
...
//   var elem = document.getElementById('medicine_table');
