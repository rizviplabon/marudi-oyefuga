  ...
  $(".table").on("click", ".editbutton", function () {
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        if (response.doctor.country) {
          $('#country_select2').val(response.doctor.country).trigger('change');
          setTimeout(function() {
            if (response.doctor.province) {
              $('#province_select2').val(response.doctor.province).trigger('change');
              setTimeout(function() {
                if (response.doctor.city) {
                  $('#city_select2').val(response.doctor.city).trigger('change');
                }
              }, 500);
            }
          }, 500);
        }
        if (response.doctor.profile !== null) {
  ...
  $(".table").on("click", ".inffo", function () {
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        $(".addressClass").append(response.doctor.address + " , " + response.city.city + " , " + response.province.province + " , " + response.country.country).end();
